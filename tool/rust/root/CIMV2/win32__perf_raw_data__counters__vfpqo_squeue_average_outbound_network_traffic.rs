...
pub struct Win32_PerfRawData_Counters_VFPQoSQueueAverageOutboundNetworkTraffic {
    #[serde(flatten)]
...
impl Win32_PerfRawData_Counters_VFPQoSQueueAverageOutboundNetworkTraffic {
