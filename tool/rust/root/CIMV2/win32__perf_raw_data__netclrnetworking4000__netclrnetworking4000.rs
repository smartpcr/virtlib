...
pub struct Win32_PerfRawData_NETCLRNetworking4000_NETCLRNetworking4000 {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "HttpWebRequestsAverageLifetime_Base")]
    pub http_web_requests_average_lifetime__base: Option<u32>,
...
/// 
    #[serde(rename = "HttpWebRequestsAverageQueueTime_Base")]
    pub http_web_requests_average_queue_time__base: Option<u32>,
...
impl Win32_PerfRawData_NETCLRNetworking4000_NETCLRNetworking4000 {
    ...
    pub fn new() -> Self {
        Self {
            ...
            http_web_requests_average_lifetime__base: None,
            http_web_requests_average_queue_time: None,
            http_web_requests_average_queue_time__base: None,
    ...
    /// Sets the value of HttpWebRequestsAverageLifetime_Base
    pub fn set_http_web_requests_average_lifetime__base(&mut self, value: u32) {
        self.http_web_requests_average_lifetime__base = Some(value);
    }

    /// Gets the value of HttpWebRequestsAverageLifetime_Base
    pub fn get_http_web_requests_average_lifetime__base(&self) -> Option<&u32> {
        self.http_web_requests_average_lifetime__base.as_ref()
    }
    ...
    /// Sets the value of HttpWebRequestsAverageQueueTime_Base
    pub fn set_http_web_requests_average_queue_time__base(&mut self, value: u32) {
        self.http_web_requests_average_queue_time__base = Some(value);
    }

    /// Gets the value of HttpWebRequestsAverageQueueTime_Base
    pub fn get_http_web_requests_average_queue_time__base(&self) -> Option<&u32> {
        self.http_web_requests_average_queue_time__base.as_ref()
    }
