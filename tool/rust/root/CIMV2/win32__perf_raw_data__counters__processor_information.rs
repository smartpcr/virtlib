...
pub struct Win32_PerfRawData_Counters_ProcessorInformation {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "ActualFrequency_Base")]
    pub actual_frequency__base: Option<u32>,
...
/// 
    #[serde(rename = "AverageIdleTime_Base")]
    pub average_idle_time__base: Option<u64>,
...
/// 
    #[serde(rename = "PercentPrivilegedUtility_Base")]
    pub percent_privileged_utility__base: Option<u32>,
...
/// 
    #[serde(rename = "PercentProcessorPerformance_Base")]
    pub percent_processor_performance__base: Option<u32>,
...
/// 
    #[serde(rename = "PercentProcessorUtility_Base")]
    pub percent_processor_utility__base: Option<u32>,
...
impl Win32_PerfRawData_Counters_ProcessorInformation {
    /// Creates a new instance of the struct
    pub fn new() -> Self {
        Self {
            base: Win32_PerfRawData::new(),
            actual_frequency: None,
            actual_frequency__base: None,
            average_idle_time: None,
            average_idle_time__base: None,
            ...
            percent_privileged_utility__base: None,
            percent_processor_performance: None,
            percent_processor_performance__base: None,
            percent_processor_time: None,
            percent_processor_utility: None,
            percent_processor_utility__base: None,
    ...
    /// Sets the value of ActualFrequency_Base
    pub fn set_actual_frequency__base(&mut self, value: u32) {
        self.actual_frequency__base = Some(value);
    }

    /// Gets the value of ActualFrequency_Base
    pub fn get_actual_frequency__base(&self) -> Option<&u32> {
        self.actual_frequency__base.as_ref()
    }
    ...
    /// Sets the value of AverageIdleTime_Base
    pub fn set_average_idle_time__base(&mut self, value: u64) {
        self.average_idle_time__base = Some(value);
    }

    /// Gets the value of AverageIdleTime_Base
    pub fn get_average_idle_time__base(&self) -> Option<&u64> {
        self.average_idle_time__base.as_ref()
    }
    ...
    /// Sets the value of PercentPrivilegedUtility_Base
    pub fn set_percent_privileged_utility__base(&mut self, value: u32) {
        self.percent_privileged_utility__base = Some(value);
    }

    /// Gets the value of PercentPrivilegedUtility_Base
    pub fn get_percent_privileged_utility__base(&self) -> Option<&u32> {
        self.percent_privileged_utility__base.as_ref()
    }
    ...
    /// Sets the value of PercentProcessorPerformance_Base
    pub fn set_percent_processor_performance__base(&mut self, value: u32) {
        self.percent_processor_performance__base = Some(value);
    }

    /// Gets the value of PercentProcessorPerformance_Base
    pub fn get_percent_processor_performance__base(&self) -> Option<&u32> {
        self.percent_processor_performance__base.as_ref()
    }
    ...
    /// Sets the value of PercentProcessorUtility_Base
    pub fn set_percent_processor_utility__base(&mut self, value: u32) {
        self.percent_processor_utility__base = Some(value);
    }

    /// Gets the value of PercentProcessorUtility_Base
    pub fn get_percent_processor_utility__base(&self) -> Option<&u32> {
        self.percent_processor_utility__base.as_ref()
    }
