...
pub struct Win32_PerfFormattedData_EthernetPerfProvider_HyperVLegacyNetworkAdapter {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_EthernetPerfProvider_HyperVLegacyNetworkAdapter {
