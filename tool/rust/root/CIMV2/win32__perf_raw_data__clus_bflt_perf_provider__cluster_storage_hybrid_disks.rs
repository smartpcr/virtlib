...
pub struct Win32_PerfRawData_ClusBfltPerfProvider_ClusterStorageHybridDisks {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "RateDiskCacheReads_Base")]
    pub rate_disk_cache_reads__base: Option<u32>,
...
/// 
    #[serde(rename = "RateDiskCacheWrites_Base")]
    pub rate_disk_cache_writes__base: Option<u32>,
...
impl Win32_PerfRawData_ClusBfltPerfProvider_ClusterStorageHybridDisks {
    ...
    pub fn new() -> Self {
        Self {
            ...
            rate_disk_cache_reads__base: None,
            rate_disk_cache_writes: None,
            rate_disk_cache_writes__base: None,
    ...
    /// Sets the value of RateDiskCacheReads_Base
    pub fn set_rate_disk_cache_reads__base(&mut self, value: u32) {
        self.rate_disk_cache_reads__base = Some(value);
    }

    /// Gets the value of RateDiskCacheReads_Base
    pub fn get_rate_disk_cache_reads__base(&self) -> Option<&u32> {
        self.rate_disk_cache_reads__base.as_ref()
    }
    ...
    /// Sets the value of RateDiskCacheWrites_Base
    pub fn set_rate_disk_cache_writes__base(&mut self, value: u32) {
        self.rate_disk_cache_writes__base = Some(value);
    }

    /// Gets the value of RateDiskCacheWrites_Base
    pub fn get_rate_disk_cache_writes__base(&self) -> Option<&u32> {
        self.rate_disk_cache_writes__base.as_ref()
    }
