...
pub struct CIM_ToDirectorySpecification {

/// 
    #[serde(rename = "DestinationDirectory")]
    pub destination_directory: Option<CIM_DirectorySpecification>,
...
impl CIM_ToDirectorySpecification {
    ...
    pub fn set_destination_directory(&mut self, value: CIM_DirectorySpecification) {
        self.destination_directory = Some(value);
    }

    /// Gets the value of DestinationDirectory
    pub fn get_destination_directory(&self) -> Option<&CIM_DirectorySpecification> {
