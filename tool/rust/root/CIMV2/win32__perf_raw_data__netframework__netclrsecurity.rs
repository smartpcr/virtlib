...
pub struct Win32_PerfRawData_NETFramework_NETCLRSecurity {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "PercentTimeinRTchecks_Base")]
    pub percent_timein_rtchecks__base: Option<u32>,
...
impl Win32_PerfRawData_NETFramework_NETCLRSecurity {
    ...
    pub fn new() -> Self {
        Self {
            ...
            percent_timein_rtchecks__base: None,
    ...
    /// Sets the value of PercentTimeinRTchecks_Base
    pub fn set_percent_timein_rtchecks__base(&mut self, value: u32) {
        self.percent_timein_rtchecks__base = Some(value);
    }

    /// Gets the value of PercentTimeinRTchecks_Base
    pub fn get_percent_timein_rtchecks__base(&self) -> Option<&u32> {
        self.percent_timein_rtchecks__base.as_ref()
    }
