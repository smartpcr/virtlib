...
pub struct Win32_PerfFormattedData_GPUPerformanceCounters_GPULocalAdapterMemory {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_GPUPerformanceCounters_GPULocalAdapterMemory {
