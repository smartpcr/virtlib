...
pub struct Win32_PerfRawData_CsvFsPerfProvider_ClusterCSVFSRedirectedIO {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "TrimLatency_Base")]
    pub trim_latency__base: Option<u32>,
...
impl Win32_PerfRawData_CsvFsPerfProvider_ClusterCSVFSRedirectedIO {
    ...
    /// Sets the value of TrimLatency_Base
    pub fn set_trim_latency__base(&mut self, value: u32) {
        self.trim_latency__base = Some(value);
    }

    /// Gets the value of TrimLatency_Base
    pub fn get_trim_latency__base(&self) -> Option<&u32> {
        self.trim_latency__base.as_ref()
    }
