...
pub struct Win32_PerfFormattedData_NetFtPerfProvider_ClusterNetftMiniportAdapter {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_NetFtPerfProvider_ClusterNetftMiniportAdapter {
