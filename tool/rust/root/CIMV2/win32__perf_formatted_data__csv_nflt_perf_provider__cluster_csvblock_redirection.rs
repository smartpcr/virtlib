...
pub struct Win32_PerfFormattedData_CsvNfltPerfProvider_ClusterCSVBlockRedirection {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_CsvNfltPerfProvider_ClusterCSVBlockRedirection {
