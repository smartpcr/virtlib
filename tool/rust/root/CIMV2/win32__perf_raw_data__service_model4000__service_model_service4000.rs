...
pub struct Win32_PerfRawData_ServiceModel4000_ServiceModelService4000 {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "CallsDuration_Base")]
    pub calls_duration__base: Option<u32>,
...
/// 
    #[serde(rename = "PercentOfMaxConcurrentCalls_Base")]
    pub percent_of_max_concurrent_calls__base: Option<u32>,
...
/// 
    #[serde(rename = "PercentOfMaxConcurrentInstances_Base")]
    pub percent_of_max_concurrent_instances__base: Option<u32>,
...
/// 
    #[serde(rename = "PercentOfMaxConcurrentSessions_Base")]
    pub percent_of_max_concurrent_sessions__base: Option<u32>,
...
impl Win32_PerfRawData_ServiceModel4000_ServiceModelService4000 {
    ...
    pub fn new() -> Self {
        Self {
            ...
            percent_of_max_concurrent_calls__base: None,
            percent_of_max_concurrent_instances: None,
            percent_of_max_concurrent_instances__base: None,
            percent_of_max_concurrent_sessions: None,
            percent_of_max_concurrent_sessions__base: None,
    ...
    /// Sets the value of CallsDuration_Base
    pub fn set_calls_duration__base(&mut self, value: u32) {
        self.calls_duration__base = Some(value);
    }

    /// Gets the value of CallsDuration_Base
    pub fn get_calls_duration__base(&self) -> Option<&u32> {
        self.calls_duration__base.as_ref()
    }
    ...
    /// Sets the value of PercentOfMaxConcurrentCalls_Base
    pub fn set_percent_of_max_concurrent_calls__base(&mut self, value: u32) {
        self.percent_of_max_concurrent_calls__base = Some(value);
    }

    /// Gets the value of PercentOfMaxConcurrentCalls_Base
    pub fn get_percent_of_max_concurrent_calls__base(&self) -> Option<&u32> {
        self.percent_of_max_concurrent_calls__base.as_ref()
    }
    ...
    /// Sets the value of PercentOfMaxConcurrentInstances_Base
    pub fn set_percent_of_max_concurrent_instances__base(&mut self, value: u32) {
        self.percent_of_max_concurrent_instances__base = Some(value);
    }

    /// Gets the value of PercentOfMaxConcurrentInstances_Base
    pub fn get_percent_of_max_concurrent_instances__base(&self) -> Option<&u32> {
        self.percent_of_max_concurrent_instances__base.as_ref()
    }
    ...
    /// Sets the value of PercentOfMaxConcurrentSessions_Base
    pub fn set_percent_of_max_concurrent_sessions__base(&mut self, value: u32) {
        self.percent_of_max_concurrent_sessions__base = Some(value);
    }

    /// Gets the value of PercentOfMaxConcurrentSessions_Base
    pub fn get_percent_of_max_concurrent_sessions__base(&self) -> Option<&u32> {
        self.percent_of_max_concurrent_sessions__base.as_ref()
    }
