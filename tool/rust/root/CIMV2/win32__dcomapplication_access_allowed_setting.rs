...
pub struct Win32_DCOMApplicationAccessAllowedSetting {

/// 
    #[serde(rename = "Element")]
    pub element: Option<Win32_DCOMApplication>,
...
impl Win32_DCOMApplicationAccessAllowedSetting {
    ...
    pub fn set_element(&mut self, value: Win32_DCOMApplication) {
        self.element = Some(value);
    }

    /// Gets the value of Element
    pub fn get_element(&self) -> Option<&Win32_DCOMApplication> {
        self.element.as_ref()
    }
