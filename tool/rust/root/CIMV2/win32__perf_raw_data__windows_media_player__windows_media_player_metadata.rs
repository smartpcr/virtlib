...
pub struct Win32_PerfRawData_WindowsMediaPlayer_WindowsMediaPlayerMetadata {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "FilesScannedPerMinute_Base")]
    pub files_scanned_per_minute__base: Option<u32>,
...
/// 
    #[serde(rename = "GrovelerServiceRoutineExecutionsPerSecond_Base")]
    pub groveler_service_routine_executions_per_second__base: Option<u32>,
...
/// 
    #[serde(rename = "LibraryDescriptionChangeNotificationsPerSecond_Base")]
    pub library_description_change_notifications_per_second__base: Option<u32>,
...
/// 
    #[serde(rename = "LibraryDescriptionUpdatesPerSecond_Base")]
    pub library_description_updates_per_second__base: Option<u32>,
...
/// 
    #[serde(rename = "MonitoredFolderUpdatesPerSecond_Base")]
    pub monitored_folder_updates_per_second__base: Option<u32>,
...
impl Win32_PerfRawData_WindowsMediaPlayer_WindowsMediaPlayerMetadata {
    ...
    pub fn new() -> Self {
        Self {
            ...
            files_scanned_per_minute__base: None,
            groveler_service_routine_executions_per_second: None,
            groveler_service_routine_executions_per_second__base: None,
            library_description_change_notifications_per_second: None,
            library_description_change_notifications_per_second__base: None,
            library_description_updates_per_second: None,
            library_description_updates_per_second__base: None,
            monitored_folder_updates_per_second: None,
            monitored_folder_updates_per_second__base: None,
    ...
    /// Sets the value of FilesScannedPerMinute_Base
    pub fn set_files_scanned_per_minute__base(&mut self, value: u32) {
        self.files_scanned_per_minute__base = Some(value);
    }

    /// Gets the value of FilesScannedPerMinute_Base
    pub fn get_files_scanned_per_minute__base(&self) -> Option<&u32> {
        self.files_scanned_per_minute__base.as_ref()
    }
    ...
    /// Sets the value of GrovelerServiceRoutineExecutionsPerSecond_Base
    pub fn set_groveler_service_routine_executions_per_second__base(&mut self, value: u32) {
        self.groveler_service_routine_executions_per_second__base = Some(value);
    }

    /// Gets the value of GrovelerServiceRoutineExecutionsPerSecond_Base
    pub fn get_groveler_service_routine_executions_per_second__base(&self) -> Option<&u32> {
        self.groveler_service_routine_executions_per_second__base.as_ref()
    }
    ...
    /// Sets the value of LibraryDescriptionChangeNotificationsPerSecond_Base
    pub fn set_library_description_change_notifications_per_second__base(&mut self, value: u32) {
        self.library_description_change_notifications_per_second__base = Some(value);
    }

    /// Gets the value of LibraryDescriptionChangeNotificationsPerSecond_Base
    pub fn get_library_description_change_notifications_per_second__base(&self) -> Option<&u32> {
        self.library_description_change_notifications_per_second__base.as_ref()
    }
    ...
    /// Sets the value of LibraryDescriptionUpdatesPerSecond_Base
    pub fn set_library_description_updates_per_second__base(&mut self, value: u32) {
        self.library_description_updates_per_second__base = Some(value);
    }

    /// Gets the value of LibraryDescriptionUpdatesPerSecond_Base
    pub fn get_library_description_updates_per_second__base(&self) -> Option<&u32> {
        self.library_description_updates_per_second__base.as_ref()
    }
    ...
    /// Sets the value of MonitoredFolderUpdatesPerSecond_Base
    pub fn set_monitored_folder_updates_per_second__base(&mut self, value: u32) {
        self.monitored_folder_updates_per_second__base = Some(value);
    }

    /// Gets the value of MonitoredFolderUpdatesPerSecond_Base
    pub fn get_monitored_folder_updates_per_second__base(&self) -> Option<&u32> {
        self.monitored_folder_updates_per_second__base.as_ref()
    }
