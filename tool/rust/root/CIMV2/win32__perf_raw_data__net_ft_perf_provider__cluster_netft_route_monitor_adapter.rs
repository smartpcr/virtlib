...
pub struct Win32_PerfRawData_NetFtPerfProvider_ClusterNetftRouteMonitorAdapter {
    #[serde(flatten)]
...
impl Win32_PerfRawData_NetFtPerfProvider_ClusterNetftRouteMonitorAdapter {
