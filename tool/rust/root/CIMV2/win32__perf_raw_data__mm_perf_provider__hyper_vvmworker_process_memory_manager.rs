...
pub struct Win32_PerfRawData_MmPerfProvider_HyperVVMWorkerProcessMemoryManager {
    #[serde(flatten)]
...
impl Win32_PerfRawData_MmPerfProvider_HyperVVMWorkerProcessMemoryManager {
