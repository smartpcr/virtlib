...
pub struct Msft_WmiProvider_PutClassAsyncEvent_Post {
    #[serde(flatten)]
    pub base: Msft_WmiProvider_OperationEvent_Post,

/// 
    #[serde(rename = "ClassObject")]
    pub class_object: Option<serde_json::Value>,
...
impl Msft_WmiProvider_PutClassAsyncEvent_Post {
    ...
    /// Sets the value of ClassObject
    pub fn set_class_object(&mut self, value: serde_json::Value) {
        self.class_object = Some(value);
    }

    /// Gets the value of ClassObject
    pub fn get_class_object(&self) -> Option<&serde_json::Value> {
