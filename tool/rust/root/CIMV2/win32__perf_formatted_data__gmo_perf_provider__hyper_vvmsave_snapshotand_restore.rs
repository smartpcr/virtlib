...
pub struct Win32_PerfFormattedData_GmoPerfProvider_HyperVVMSaveSnapshotandRestore {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_GmoPerfProvider_HyperVVMSaveSnapshotandRestore {
