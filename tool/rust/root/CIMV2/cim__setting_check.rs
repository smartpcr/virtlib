...
pub struct CIM_SettingCheck {
    #[serde(flatten)]
    pub base: CIM_Check,

/// 
    #[serde(rename = "CheckType")]
    pub check_type: Option<u16>,
...
impl CIM_SettingCheck {
    ...
    /// Sets the value of CheckType
    pub fn set_check_type(&mut self, value: u16) {
        self.check_type = Some(value);
    }

    /// Gets the value of CheckType
    pub fn get_check_type(&self) -> Option<&u16> {
        self.check_type.as_ref()
    }
