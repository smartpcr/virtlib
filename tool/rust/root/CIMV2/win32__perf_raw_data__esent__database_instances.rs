...
pub struct Win32_PerfRawData_ESENT_DatabaseInstances {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "IODatabaseReadsAttachedAverageLatency_Base")]
    pub iodatabase_reads_attached_average_latency__base: Option<u32>,
...
/// 
    #[serde(rename = "IODatabaseReadsRecoveryAverageLatency_Base")]
    pub iodatabase_reads_recovery_average_latency__base: Option<u32>,
...
/// 
    #[serde(rename = "IODatabaseWritesAttachedAverageLatency_Base")]
    pub iodatabase_writes_attached_average_latency__base: Option<u32>,
...
/// 
    #[serde(rename = "IODatabaseWritesRecoveryAverageLatency_Base")]
    pub iodatabase_writes_recovery_average_latency__base: Option<u32>,
...
/// 
    #[serde(rename = "IOFlushMapWritesAverageLatency_Base")]
    pub ioflush_map_writes_average_latency__base: Option<u32>,
...
/// 
    #[serde(rename = "IOLogReadsAverageLatency_Base")]
    pub iolog_reads_average_latency__base: Option<u32>,
...
/// 
    #[serde(rename = "IOLogWritesAverageLatency_Base")]
    pub iolog_writes_average_latency__base: Option<u32>,
...
/// 
    #[serde(rename = "LogCheckpointDepthasaPercentofTarget_Base")]
    pub log_checkpoint_depthasa_percentof_target__base: Option<u32>,
...
/// 
    #[serde(rename = "SessionsPercentUsed_Base")]
    pub sessions_percent_used__base: Option<u32>,
...
/// 
    #[serde(rename = "TableOpenCachePercentHit_Base")]
    pub table_open_cache_percent_hit__base: Option<u32>,
...
impl Win32_PerfRawData_ESENT_DatabaseInstances {
    ...
    pub fn new() -> Self {
        Self {
            ...
            iodatabase_reads_attached_average_latency__base: None,
            ...
            iodatabase_reads_recovery_average_latency__base: None,
            iodatabase_reads_recovery_persec: None,
            iodatabase_writes_attached_average_latency: None,
            iodatabase_writes_attached_average_latency__base: None,
            ...
            log_checkpoint_depthasa_percentof_target__base: None,
            ...
            sessions_percent_used__base: None,
            ...
            table_open_cache_percent_hit__base: None,
    ...
    /// Sets the value of IODatabaseReadsAttachedAverageLatency_Base
    pub fn set_iodatabase_reads_attached_average_latency__base(&mut self, value: u32) {
        self.iodatabase_reads_attached_average_latency__base = Some(value);
    }

    /// Gets the value of IODatabaseReadsAttachedAverageLatency_Base
    pub fn get_iodatabase_reads_attached_average_latency__base(&self) -> Option<&u32> {
        self.iodatabase_reads_attached_average_latency__base.as_ref()
    }
    ...
    /// Sets the value of IODatabaseReadsRecoveryAverageLatency_Base
    pub fn set_iodatabase_reads_recovery_average_latency__base(&mut self, value: u32) {
        self.iodatabase_reads_recovery_average_latency__base = Some(value);
    }

    /// Gets the value of IODatabaseReadsRecoveryAverageLatency_Base
    pub fn get_iodatabase_reads_recovery_average_latency__base(&self) -> Option<&u32> {
        self.iodatabase_reads_recovery_average_latency__base.as_ref()
    }
    ...
    /// Sets the value of IODatabaseWritesAttachedAverageLatency_Base
    pub fn set_iodatabase_writes_attached_average_latency__base(&mut self, value: u32) {
        self.iodatabase_writes_attached_average_latency__base = Some(value);
    }

    /// Gets the value of IODatabaseWritesAttachedAverageLatency_Base
    pub fn get_iodatabase_writes_attached_average_latency__base(&self) -> Option<&u32> {
        self.iodatabase_writes_attached_average_latency__base.as_ref()
    }
    ...
    /// Sets the value of IODatabaseWritesRecoveryAverageLatency_Base
    pub fn set_iodatabase_writes_recovery_average_latency__base(&mut self, value: u32) {
        self.iodatabase_writes_recovery_average_latency__base = Some(value);
    }

    /// Gets the value of IODatabaseWritesRecoveryAverageLatency_Base
    pub fn get_iodatabase_writes_recovery_average_latency__base(&self) -> Option<&u32> {
        self.iodatabase_writes_recovery_average_latency__base.as_ref()
    }
    ...
    /// Sets the value of IOFlushMapWritesAverageLatency_Base
    pub fn set_ioflush_map_writes_average_latency__base(&mut self, value: u32) {
        self.ioflush_map_writes_average_latency__base = Some(value);
    }

    /// Gets the value of IOFlushMapWritesAverageLatency_Base
    pub fn get_ioflush_map_writes_average_latency__base(&self) -> Option<&u32> {
        self.ioflush_map_writes_average_latency__base.as_ref()
    }
    ...
    /// Sets the value of IOLogReadsAverageLatency_Base
    pub fn set_iolog_reads_average_latency__base(&mut self, value: u32) {
        self.iolog_reads_average_latency__base = Some(value);
    }

    /// Gets the value of IOLogReadsAverageLatency_Base
    pub fn get_iolog_reads_average_latency__base(&self) -> Option<&u32> {
        self.iolog_reads_average_latency__base.as_ref()
    }
    ...
    /// Sets the value of IOLogWritesAverageLatency_Base
    pub fn set_iolog_writes_average_latency__base(&mut self, value: u32) {
        self.iolog_writes_average_latency__base = Some(value);
    }

    /// Gets the value of IOLogWritesAverageLatency_Base
    pub fn get_iolog_writes_average_latency__base(&self) -> Option<&u32> {
        self.iolog_writes_average_latency__base.as_ref()
    }
    ...
    /// Sets the value of LogCheckpointDepthasaPercentofTarget_Base
    pub fn set_log_checkpoint_depthasa_percentof_target__base(&mut self, value: u32) {
        self.log_checkpoint_depthasa_percentof_target__base = Some(value);
    }

    /// Gets the value of LogCheckpointDepthasaPercentofTarget_Base
    pub fn get_log_checkpoint_depthasa_percentof_target__base(&self) -> Option<&u32> {
        self.log_checkpoint_depthasa_percentof_target__base.as_ref()
    }
    ...
    /// Sets the value of SessionsPercentUsed_Base
    pub fn set_sessions_percent_used__base(&mut self, value: u32) {
        self.sessions_percent_used__base = Some(value);
    }

    /// Gets the value of SessionsPercentUsed_Base
    pub fn get_sessions_percent_used__base(&self) -> Option<&u32> {
        self.sessions_percent_used__base.as_ref()
    }
    ...
    /// Sets the value of TableOpenCachePercentHit_Base
    pub fn set_table_open_cache_percent_hit__base(&mut self, value: u32) {
        self.table_open_cache_percent_hit__base = Some(value);
    }

    /// Gets the value of TableOpenCachePercentHit_Base
    pub fn get_table_open_cache_percent_hit__base(&self) -> Option<&u32> {
        self.table_open_cache_percent_hit__base.as_ref()
    }
