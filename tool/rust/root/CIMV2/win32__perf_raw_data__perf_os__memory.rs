...
pub struct Win32_PerfRawData_PerfOS_Memory {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "PercentCommittedBytesInUse_Base")]
    pub percent_committed_bytes_in_use__base: Option<u32>,
...
impl Win32_PerfRawData_PerfOS_Memory {
    ...
    pub fn new() -> Self {
        Self {
            ...
            percent_committed_bytes_in_use__base: None,
    ...
    /// Sets the value of PercentCommittedBytesInUse_Base
    pub fn set_percent_committed_bytes_in_use__base(&mut self, value: u32) {
        self.percent_committed_bytes_in_use__base = Some(value);
    }

    /// Gets the value of PercentCommittedBytesInUse_Base
    pub fn get_percent_committed_bytes_in_use__base(&self) -> Option<&u32> {
        self.percent_committed_bytes_in_use__base.as_ref()
    }
