...
pub struct Win32_PerfRawData_Counters_DCLocatorDC {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "PingsAverageMailslotPingLatencysecs_Base")]
    pub pings_average_mailslot_ping_latencysecs__base: Option<u32>,
...
/// 
    #[serde(rename = "PingsAverageUDPLDAPPingLatencysecs_Base")]
    pub pings_average_udpldapping_latencysecs__base: Option<u32>,
...
impl Win32_PerfRawData_Counters_DCLocatorDC {
    ...
    pub fn new() -> Self {
        Self {
            ...
            pings_average_mailslot_ping_latencysecs__base: None,
            pings_average_udpldapping_latencysecs: None,
            pings_average_udpldapping_latencysecs__base: None,
    ...
    /// Sets the value of PingsAverageMailslotPingLatencysecs_Base
    pub fn set_pings_average_mailslot_ping_latencysecs__base(&mut self, value: u32) {
        self.pings_average_mailslot_ping_latencysecs__base = Some(value);
    }

    /// Gets the value of PingsAverageMailslotPingLatencysecs_Base
    pub fn get_pings_average_mailslot_ping_latencysecs__base(&self) -> Option<&u32> {
        self.pings_average_mailslot_ping_latencysecs__base.as_ref()
    }
    ...
    /// Sets the value of PingsAverageUDPLDAPPingLatencysecs_Base
    pub fn set_pings_average_udpldapping_latencysecs__base(&mut self, value: u32) {
        self.pings_average_udpldapping_latencysecs__base = Some(value);
    }

    /// Gets the value of PingsAverageUDPLDAPPingLatencysecs_Base
    pub fn get_pings_average_udpldapping_latencysecs__base(&self) -> Option<&u32> {
        self.pings_average_udpldapping_latencysecs__base.as_ref()
    }
