...
pub struct Win32_PerfFormattedData_Counters_VFPQoSQueueTotalInboundNetworkTraffic {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_Counters_VFPQoSQueueTotalInboundNetworkTraffic {
