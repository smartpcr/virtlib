...
pub struct Win32_PerfRawData_Counters_StorageSpacesVirtualDisk {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "VirtualDiskScrubLatencyms_Base")]
    pub virtual_disk_scrub_latencyms__base: Option<u32>,
...
impl Win32_PerfRawData_Counters_StorageSpacesVirtualDisk {
    ...
    pub fn new() -> Self {
        Self {
            ...
            virtual_disk_scrub_latencyms__base: None,
    ...
    /// Sets the value of VirtualDiskScrubLatencyms_Base
    pub fn set_virtual_disk_scrub_latencyms__base(&mut self, value: u32) {
        self.virtual_disk_scrub_latencyms__base = Some(value);
    }

    /// Gets the value of VirtualDiskScrubLatencyms_Base
    pub fn get_virtual_disk_scrub_latencyms__base(&self) -> Option<&u32> {
        self.virtual_disk_scrub_latencyms__base.as_ref()
    }
