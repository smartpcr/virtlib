...
pub struct Win32_PerfRawData_NumaPerfProvider_HyperVVMWorkerProcessNUMAManager {
    #[serde(flatten)]
...
impl Win32_PerfRawData_NumaPerfProvider_HyperVVMWorkerProcessNUMAManager {
