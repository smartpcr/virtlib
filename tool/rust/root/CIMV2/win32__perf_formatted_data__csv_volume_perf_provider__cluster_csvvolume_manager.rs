...
pub struct Win32_PerfFormattedData_CsvVolumePerfProvider_ClusterCSVVolumeManager {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_CsvVolumePerfProvider_ClusterCSVVolumeManager {
