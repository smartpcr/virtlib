...
pub struct Win32_PerfRawData_Counters_DCLocatorNetlogon {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "RequestsAverageFailureLatencysecs_Base")]
    pub requests_average_failure_latencysecs__base: Option<u32>,
...
/// 
    #[serde(rename = "RequestsAverageSuccessLatencysecs_Base")]
    pub requests_average_success_latencysecs__base: Option<u32>,
...
impl Win32_PerfRawData_Counters_DCLocatorNetlogon {
    ...
    pub fn new() -> Self {
        Self {
            ...
            requests_average_failure_latencysecs__base: None,
            requests_average_success_latencysecs: None,
            requests_average_success_latencysecs__base: None,
    ...
    /// Sets the value of RequestsAverageFailureLatencysecs_Base
    pub fn set_requests_average_failure_latencysecs__base(&mut self, value: u32) {
        self.requests_average_failure_latencysecs__base = Some(value);
    }

    /// Gets the value of RequestsAverageFailureLatencysecs_Base
    pub fn get_requests_average_failure_latencysecs__base(&self) -> Option<&u32> {
        self.requests_average_failure_latencysecs__base.as_ref()
    }
    ...
    /// Sets the value of RequestsAverageSuccessLatencysecs_Base
    pub fn set_requests_average_success_latencysecs__base(&mut self, value: u32) {
        self.requests_average_success_latencysecs__base = Some(value);
    }

    /// Gets the value of RequestsAverageSuccessLatencysecs_Base
    pub fn get_requests_average_success_latencysecs__base(&self) -> Option<&u32> {
        self.requests_average_success_latencysecs__base.as_ref()
    }
