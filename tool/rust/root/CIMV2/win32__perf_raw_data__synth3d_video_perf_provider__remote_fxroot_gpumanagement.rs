...
pub struct Win32_PerfRawData_Synth3dVideoPerfProvider_RemoteFXRootGPUManagement {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "VRAMReservedPercentperGPU_Base")]
    pub vramreserved_percentper_gpu__base: Option<u64>,
}

impl Win32_PerfRawData_Synth3dVideoPerfProvider_RemoteFXRootGPUManagement {
    ...
    pub fn new() -> Self {
        Self {
            ...
            vramreserved_percentper_gpu__base: None,
        }
    }
    ...
    /// Sets the value of VRAMReservedPercentperGPU_Base
    pub fn set_vramreserved_percentper_gpu__base(&mut self, value: u64) {
        self.vramreserved_percentper_gpu__base = Some(value);
    }

    /// Gets the value of VRAMReservedPercentperGPU_Base
    pub fn get_vramreserved_percentper_gpu__base(&self) -> Option<&u64> {
        self.vramreserved_percentper_gpu__base.as_ref()
    }
}
