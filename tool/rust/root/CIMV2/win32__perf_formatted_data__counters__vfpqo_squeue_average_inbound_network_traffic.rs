...
pub struct Win32_PerfFormattedData_Counters_VFPQoSQueueAverageInboundNetworkTraffic {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_Counters_VFPQoSQueueAverageInboundNetworkTraffic {
