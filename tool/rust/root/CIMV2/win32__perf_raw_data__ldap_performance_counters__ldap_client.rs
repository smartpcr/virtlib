...
pub struct Win32_PerfRawData_LdapPerformanceCounters_LdapClient {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "ResponsesAverageResponseTime_Base")]
    pub responses_average_response_time__base: Option<u32>,
...
impl Win32_PerfRawData_LdapPerformanceCounters_LdapClient {
    ...
    pub fn new() -> Self {
        Self {
            ...
            responses_average_response_time__base: None,
    ...
    /// Sets the value of ResponsesAverageResponseTime_Base
    pub fn set_responses_average_response_time__base(&mut self, value: u32) {
        self.responses_average_response_time__base = Some(value);
    }

    /// Gets the value of ResponsesAverageResponseTime_Base
    pub fn get_responses_average_response_time__base(&self) -> Option<&u32> {
        self.responses_average_response_time__base.as_ref()
    }
