...
pub struct Win32_PerfFormattedData_Counters_HyperVVirtualMachineBusProviderPipes {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_Counters_HyperVVirtualMachineBusProviderPipes {
