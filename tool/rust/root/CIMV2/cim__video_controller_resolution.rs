...
/// 
    #[serde(rename = "NumberOfColors")]
    pub number_of_colors: Option<u64>,
...
impl CIM_VideoControllerResolution {
    ...
    /// Sets the value of NumberOfColors
    pub fn set_number_of_colors(&mut self, value: u64) {
        self.number_of_colors = Some(value);
    }

    /// Gets the value of NumberOfColors
    pub fn get_number_of_colors(&self) -> Option<&u64> {
        self.number_of_colors.as_ref()
    }
