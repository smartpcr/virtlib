...
pub struct CIM_FRUIncludesProduct {

/// 
    #[serde(rename = "Component")]
    pub component: Option<CIM_Product>,
...
impl CIM_FRUIncludesProduct {
    ...
    pub fn set_component(&mut self, value: CIM_Product) {
        self.component = Some(value);
    }

    /// Gets the value of Component
    pub fn get_component(&self) -> Option<&CIM_Product> {
