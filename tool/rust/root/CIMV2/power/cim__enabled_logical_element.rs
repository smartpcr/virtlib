...
/// 
    ...
    pub available_requested_states: Vec<u16>,
...
/// 
    ...
    pub transitioning_to_state: Option<u16>,
}
...
impl CIM_EnabledLogicalElement {
    ...
    pub fn set_available_requested_states(&mut self, value: Vec<u16>) {
        self.available_requested_states = value;
    }

    /// Gets the value of AvailableRequestedStates
    pub fn get_available_requested_states(&self) -> &Vec<u16> {
    ...
    pub fn set_transitioning_to_state(&mut self, value: u16) {
        self.transitioning_to_state = Some(value);
    }

    /// Gets the value of TransitioningToState
    pub fn get_transitioning_to_state(&self) -> Option<&u16> {
