...
pub struct Win32_PerfRawData_PerfOS_Cache {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "CopyReadHitsPercent_Base")]
    pub copy_read_hits_percent__base: Option<u32>,
...
/// 
    #[serde(rename = "DataMapHitsPercent_Base")]
    pub data_map_hits_percent__base: Option<u32>,
...
/// 
    #[serde(rename = "DataMapPinsPersec_Base")]
    pub data_map_pins_persec__base: Option<u32>,
...
/// 
    #[serde(rename = "MDLReadHitsPercent_Base")]
    pub mdlread_hits_percent__base: Option<u32>,
...
/// 
    #[serde(rename = "PinReadHitsPercent_Base")]
    pub pin_read_hits_percent__base: Option<u32>,
...
impl Win32_PerfRawData_PerfOS_Cache {
    ...
    pub fn new() -> Self {
        Self {
            ...
            mdlread_hits_percent__base: None,
            mdlreads_persec: None,
            pin_read_hits_percent: None,
            pin_read_hits_percent__base: None,
    ...
    /// Sets the value of CopyReadHitsPercent_Base
    pub fn set_copy_read_hits_percent__base(&mut self, value: u32) {
        self.copy_read_hits_percent__base = Some(value);
    }

    /// Gets the value of CopyReadHitsPercent_Base
    pub fn get_copy_read_hits_percent__base(&self) -> Option<&u32> {
        self.copy_read_hits_percent__base.as_ref()
    }
    ...
    /// Sets the value of DataMapHitsPercent_Base
    pub fn set_data_map_hits_percent__base(&mut self, value: u32) {
        self.data_map_hits_percent__base = Some(value);
    }

    /// Gets the value of DataMapHitsPercent_Base
    pub fn get_data_map_hits_percent__base(&self) -> Option<&u32> {
        self.data_map_hits_percent__base.as_ref()
    }
    ...
    /// Sets the value of DataMapPinsPersec_Base
    pub fn set_data_map_pins_persec__base(&mut self, value: u32) {
        self.data_map_pins_persec__base = Some(value);
    }

    /// Gets the value of DataMapPinsPersec_Base
    pub fn get_data_map_pins_persec__base(&self) -> Option<&u32> {
        self.data_map_pins_persec__base.as_ref()
    }
    ...
    /// Sets the value of MDLReadHitsPercent_Base
    pub fn set_mdlread_hits_percent__base(&mut self, value: u32) {
        self.mdlread_hits_percent__base = Some(value);
    }

    /// Gets the value of MDLReadHitsPercent_Base
    pub fn get_mdlread_hits_percent__base(&self) -> Option<&u32> {
        self.mdlread_hits_percent__base.as_ref()
    }
    ...
    /// Sets the value of PinReadHitsPercent_Base
    pub fn set_pin_read_hits_percent__base(&mut self, value: u32) {
        self.pin_read_hits_percent__base = Some(value);
    }

    /// Gets the value of PinReadHitsPercent_Base
    pub fn get_pin_read_hits_percent__base(&self) -> Option<&u32> {
        self.pin_read_hits_percent__base.as_ref()
    }
