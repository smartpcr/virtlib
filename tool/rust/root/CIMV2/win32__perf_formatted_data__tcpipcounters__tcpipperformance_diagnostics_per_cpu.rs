...
pub struct Win32_PerfFormattedData_TCPIPCounters_TCPIPPerformanceDiagnosticsPerCPU {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_TCPIPCounters_TCPIPPerformanceDiagnosticsPerCPU {
