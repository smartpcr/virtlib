...
pub struct Win32_PerfRawData_MSDTCBridge4000_MSDTCBridge4000 {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "Averageparticipantcommitresponsetime_Base")]
    pub averageparticipantcommitresponsetime__base: Option<u32>,
...
/// 
    #[serde(rename = "Averageparticipantprepareresponsetime_Base")]
    pub averageparticipantprepareresponsetime__base: Option<u32>,
...
impl Win32_PerfRawData_MSDTCBridge4000_MSDTCBridge4000 {
    /// Creates a new instance of the struct
    pub fn new() -> Self {
        Self {
            base: Win32_PerfRawData::new(),
            averageparticipantcommitresponsetime: None,
            averageparticipantcommitresponsetime__base: None,
            averageparticipantprepareresponsetime: None,
            averageparticipantprepareresponsetime__base: None,
    ...
    /// Sets the value of Averageparticipantcommitresponsetime_Base
    pub fn set_averageparticipantcommitresponsetime__base(&mut self, value: u32) {
        self.averageparticipantcommitresponsetime__base = Some(value);
    }

    /// Gets the value of Averageparticipantcommitresponsetime_Base
    pub fn get_averageparticipantcommitresponsetime__base(&self) -> Option<&u32> {
        self.averageparticipantcommitresponsetime__base.as_ref()
    }
    ...
    /// Sets the value of Averageparticipantprepareresponsetime_Base
    pub fn set_averageparticipantprepareresponsetime__base(&mut self, value: u32) {
        self.averageparticipantprepareresponsetime__base = Some(value);
    }

    /// Gets the value of Averageparticipantprepareresponsetime_Base
    pub fn get_averageparticipantprepareresponsetime__base(&self) -> Option<&u32> {
        self.averageparticipantprepareresponsetime__base.as_ref()
    }
