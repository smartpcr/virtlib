...
pub struct Win32_PerfFormattedData_Counters_VFPPortTotalOutboundNetworkTraffic {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_Counters_VFPPortTotalOutboundNetworkTraffic {
