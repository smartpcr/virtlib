...
pub struct Win32_PerfFormattedData_Counters_IPsecAuthIPIPv4 {
    #[serde(flatten)]
    pub base: Win32_PerfFormattedData,

/// 
    #[serde(rename = "ActiveExtendedModeSAs")]
    pub active_extended_mode_sas: Option<u32>,
...
/// 
    #[serde(rename = "ExtendedModeNegotiations")]
    pub extended_mode_negotiations: Option<u32>,

/// 
    #[serde(rename = "ExtendedModeNegotiationsPersec")]
    pub extended_mode_negotiations_persec: Option<u32>,

/// 
    #[serde(rename = "ExtendedModeSAsThatUsedImpersonation")]
    pub extended_mode_sas_that_used_impersonation: Option<u32>,

/// 
    #[serde(rename = "FailedExtendedModeNegotiations")]
    pub failed_extended_mode_negotiations: Option<u32>,

/// 
    #[serde(rename = "FailedExtendedModeNegotiationsPersec")]
    pub failed_extended_mode_negotiations_persec: Option<u32>,
...
/// 
    #[serde(rename = "MainModeSAsThatUsedImpersonation")]
    pub main_mode_sas_that_used_impersonation: Option<u32>,

/// 
    #[serde(rename = "MainModeSAsThatUsedImpersonationPersec")]
    pub main_mode_sas_that_used_impersonation_persec: Option<u32>,

/// 
    #[serde(rename = "PendingExtendedModeNegotiations")]
    pub pending_extended_mode_negotiations: Option<u32>,
...
/// 
    #[serde(rename = "SuccessfulExtendedModeNegotiations")]
    pub successful_extended_mode_negotiations: Option<u32>,

/// 
    #[serde(rename = "SuccessfulExtendedModeNegotiationsPersec")]
    pub successful_extended_mode_negotiations_persec: Option<u32>,
...
impl Win32_PerfFormattedData_Counters_IPsecAuthIPIPv4 {
    /// Creates a new instance of the struct
    pub fn new() -> Self {
        Self {
            base: Win32_PerfFormattedData::new(),
            active_extended_mode_sas: None,
            active_main_mode_sas: None,
            active_quick_mode_sas: None,
            extended_mode_negotiations: None,
            extended_mode_negotiations_persec: None,
            extended_mode_sas_that_used_impersonation: None,
            failed_extended_mode_negotiations: None,
            failed_extended_mode_negotiations_persec: None,
            ...
            main_mode_sas_that_used_impersonation: None,
            main_mode_sas_that_used_impersonation_persec: None,
            pending_extended_mode_negotiations: None,
            ...
            successful_extended_mode_negotiations: None,
            successful_extended_mode_negotiations_persec: None,
    ...
    /// Sets the value of ActiveExtendedModeSAs
    pub fn set_active_extended_mode_sas(&mut self, value: u32) {
        self.active_extended_mode_sas = Some(value);
    }

    /// Gets the value of ActiveExtendedModeSAs
    pub fn get_active_extended_mode_sas(&self) -> Option<&u32> {
        self.active_extended_mode_sas.as_ref()
    }
    ...
    /// Sets the value of ExtendedModeNegotiations
    pub fn set_extended_mode_negotiations(&mut self, value: u32) {
        self.extended_mode_negotiations = Some(value);
    }

    /// Gets the value of ExtendedModeNegotiations
    pub fn get_extended_mode_negotiations(&self) -> Option<&u32> {
        self.extended_mode_negotiations.as_ref()
    }

    /// Sets the value of ExtendedModeNegotiationsPersec
    pub fn set_extended_mode_negotiations_persec(&mut self, value: u32) {
        self.extended_mode_negotiations_persec = Some(value);
    }

    /// Gets the value of ExtendedModeNegotiationsPersec
    pub fn get_extended_mode_negotiations_persec(&self) -> Option<&u32> {
        self.extended_mode_negotiations_persec.as_ref()
    }

    /// Sets the value of ExtendedModeSAsThatUsedImpersonation
    pub fn set_extended_mode_sas_that_used_impersonation(&mut self, value: u32) {
        self.extended_mode_sas_that_used_impersonation = Some(value);
    }

    /// Gets the value of ExtendedModeSAsThatUsedImpersonation
    pub fn get_extended_mode_sas_that_used_impersonation(&self) -> Option<&u32> {
        self.extended_mode_sas_that_used_impersonation.as_ref()
    }

    /// Sets the value of FailedExtendedModeNegotiations
    pub fn set_failed_extended_mode_negotiations(&mut self, value: u32) {
        self.failed_extended_mode_negotiations = Some(value);
    }

    /// Gets the value of FailedExtendedModeNegotiations
    pub fn get_failed_extended_mode_negotiations(&self) -> Option<&u32> {
        self.failed_extended_mode_negotiations.as_ref()
    }

    /// Sets the value of FailedExtendedModeNegotiationsPersec
    pub fn set_failed_extended_mode_negotiations_persec(&mut self, value: u32) {
        self.failed_extended_mode_negotiations_persec = Some(value);
    }

    /// Gets the value of FailedExtendedModeNegotiationsPersec
    pub fn get_failed_extended_mode_negotiations_persec(&self) -> Option<&u32> {
        self.failed_extended_mode_negotiations_persec.as_ref()
    }
    ...
    /// Sets the value of MainModeSAsThatUsedImpersonation
    pub fn set_main_mode_sas_that_used_impersonation(&mut self, value: u32) {
        self.main_mode_sas_that_used_impersonation = Some(value);
    }

    /// Gets the value of MainModeSAsThatUsedImpersonation
    pub fn get_main_mode_sas_that_used_impersonation(&self) -> Option<&u32> {
        self.main_mode_sas_that_used_impersonation.as_ref()
    }

    /// Sets the value of MainModeSAsThatUsedImpersonationPersec
    pub fn set_main_mode_sas_that_used_impersonation_persec(&mut self, value: u32) {
        self.main_mode_sas_that_used_impersonation_persec = Some(value);
    }

    /// Gets the value of MainModeSAsThatUsedImpersonationPersec
    pub fn get_main_mode_sas_that_used_impersonation_persec(&self) -> Option<&u32> {
        self.main_mode_sas_that_used_impersonation_persec.as_ref()
    }

    /// Sets the value of PendingExtendedModeNegotiations
    pub fn set_pending_extended_mode_negotiations(&mut self, value: u32) {
        self.pending_extended_mode_negotiations = Some(value);
    }

    /// Gets the value of PendingExtendedModeNegotiations
    pub fn get_pending_extended_mode_negotiations(&self) -> Option<&u32> {
        self.pending_extended_mode_negotiations.as_ref()
    }
    ...
    /// Sets the value of SuccessfulExtendedModeNegotiations
    pub fn set_successful_extended_mode_negotiations(&mut self, value: u32) {
        self.successful_extended_mode_negotiations = Some(value);
    }

    /// Gets the value of SuccessfulExtendedModeNegotiations
    pub fn get_successful_extended_mode_negotiations(&self) -> Option<&u32> {
        self.successful_extended_mode_negotiations.as_ref()
    }

    /// Sets the value of SuccessfulExtendedModeNegotiationsPersec
    pub fn set_successful_extended_mode_negotiations_persec(&mut self, value: u32) {
        self.successful_extended_mode_negotiations_persec = Some(value);
    }

    /// Gets the value of SuccessfulExtendedModeNegotiationsPersec
    pub fn get_successful_extended_mode_negotiations_persec(&self) -> Option<&u32> {
        self.successful_extended_mode_negotiations_persec.as_ref()
    }
