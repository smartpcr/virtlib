...
pub struct Win32_PerfFormattedData_Counters_PhysicalNetworkInterfaceCardActivity {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_Counters_PhysicalNetworkInterfaceCardActivity {
