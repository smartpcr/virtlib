...
pub struct Win32_PerfFormattedData_PerfProc_JobObjectDetails {
    #[serde(flatten)]
    pub base: Win32_PerfFormattedData,

/// 
    #[serde(rename = "CreatingProcessID")]
    pub creating_process_id: Option<u64>,
...
impl Win32_PerfFormattedData_PerfProc_JobObjectDetails {
    ...
    pub fn set_creating_process_id(&mut self, value: u64) {
        self.creating_process_id = Some(value);
    }

    /// Gets the value of CreatingProcessID
    pub fn get_creating_process_id(&self) -> Option<&u64> {
    ...
    pub fn set_idprocess(&mut self, value: u64) {
        self.idprocess = Some(value);
    }

    /// Gets the value of IDProcess
    pub fn get_idprocess(&self) -> Option<&u64> {
