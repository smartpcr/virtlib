...
pub struct Win32_PerfRawData_Counters_PacketDirectECUtilization {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "PercentBusyWaitingTime_Base")]
    pub percent_busy_waiting_time__base: Option<u64>,
...
/// 
    #[serde(rename = "PercentBusyWaitIterations_Base")]
    pub percent_busy_wait_iterations__base: Option<u32>,
...
/// 
    #[serde(rename = "PercentProcessingTime_Base")]
    pub percent_processing_time__base: Option<u64>,
...
impl Win32_PerfRawData_Counters_PacketDirectECUtilization {
    ...
    /// Sets the value of PercentBusyWaitingTime_Base
    pub fn set_percent_busy_waiting_time__base(&mut self, value: u64) {
        self.percent_busy_waiting_time__base = Some(value);
    }

    /// Gets the value of PercentBusyWaitingTime_Base
    pub fn get_percent_busy_waiting_time__base(&self) -> Option<&u64> {
        self.percent_busy_waiting_time__base.as_ref()
    }
    ...
    /// Sets the value of PercentBusyWaitIterations_Base
    pub fn set_percent_busy_wait_iterations__base(&mut self, value: u32) {
        self.percent_busy_wait_iterations__base = Some(value);
    }

    /// Gets the value of PercentBusyWaitIterations_Base
    pub fn get_percent_busy_wait_iterations__base(&self) -> Option<&u32> {
        self.percent_busy_wait_iterations__base.as_ref()
    }
    ...
    /// Sets the value of PercentProcessingTime_Base
    pub fn set_percent_processing_time__base(&mut self, value: u64) {
        self.percent_processing_time__base = Some(value);
    }

    /// Gets the value of PercentProcessingTime_Base
    pub fn get_percent_processing_time__base(&self) -> Option<&u64> {
        self.percent_processing_time__base.as_ref()
    }
