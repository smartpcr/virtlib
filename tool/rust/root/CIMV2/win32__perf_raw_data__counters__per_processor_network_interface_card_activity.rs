...
pub struct Win32_PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity {
    #[serde(flatten)]
...
impl Win32_PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity {
