...
pub struct Win32_PerfFormattedData_ClussvcPerfProvider_ClusterNetworkReconnections {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_ClussvcPerfProvider_ClusterNetworkReconnections {
