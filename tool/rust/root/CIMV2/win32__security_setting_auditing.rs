...
pub struct Win32_SecuritySettingAuditing {

/// 
    #[serde(rename = "AuditedAccessMask")]
    pub audited_access_mask: Option<u32>,
...
impl Win32_SecuritySettingAuditing {
    /// Creates a new instance of the struct
    pub fn new() -> Self {
        Self {
            audited_access_mask: None,
    ...
    /// Sets the value of AuditedAccessMask
    pub fn set_audited_access_mask(&mut self, value: u32) {
        self.audited_access_mask = Some(value);
    }

    /// Gets the value of AuditedAccessMask
    pub fn get_audited_access_mask(&self) -> Option<&u32> {
        self.audited_access_mask.as_ref()
    }
