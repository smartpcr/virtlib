...
pub struct Win32_PerfFormattedData_IdePerfProvider_HyperVVirtualIDEControllerEmulated {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_IdePerfProvider_HyperVVirtualIDEControllerEmulated {
