...
pub struct Win32_PerfRawData_HvStats_HyperVHypervisorLogicalProcessor {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "PercentC1Time_Base")]
    pub percent_c1_time__base: Option<u64>,
...
/// 
    #[serde(rename = "PercentC2Time_Base")]
    pub percent_c2_time__base: Option<u64>,
...
/// 
    #[serde(rename = "PercentC3Time_Base")]
    pub percent_c3_time__base: Option<u64>,
...
impl Win32_PerfRawData_HvStats_HyperVHypervisorLogicalProcessor {
    ...
    pub fn new() -> Self {
        Self {
            ...
            percent_c1_time__base: None,
            percent_c2_time: None,
            percent_c2_time__base: None,
            percent_c3_time: None,
            percent_c3_time__base: None,
    ...
    /// Sets the value of PercentC1Time_Base
    pub fn set_percent_c1_time__base(&mut self, value: u64) {
        self.percent_c1_time__base = Some(value);
    }

    /// Gets the value of PercentC1Time_Base
    pub fn get_percent_c1_time__base(&self) -> Option<&u64> {
        self.percent_c1_time__base.as_ref()
    }
    ...
    /// Sets the value of PercentC2Time_Base
    pub fn set_percent_c2_time__base(&mut self, value: u64) {
        self.percent_c2_time__base = Some(value);
    }

    /// Gets the value of PercentC2Time_Base
    pub fn get_percent_c2_time__base(&self) -> Option<&u64> {
        self.percent_c2_time__base.as_ref()
    }
    ...
    /// Sets the value of PercentC3Time_Base
    pub fn set_percent_c3_time__base(&mut self, value: u64) {
        self.percent_c3_time__base = Some(value);
    }

    /// Gets the value of PercentC3Time_Base
    pub fn get_percent_c3_time__base(&self) -> Option<&u64> {
        self.percent_c3_time__base.as_ref()
    }
