...
pub struct Win32_PerfRawData_PerfDisk_LogicalDisk {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "AvgDiskBytesPerRead_Base")]
    pub avg_disk_bytes_per_read__base: Option<u32>,
...
/// 
    #[serde(rename = "AvgDiskBytesPerTransfer_Base")]
    pub avg_disk_bytes_per_transfer__base: Option<u32>,
...
/// 
    #[serde(rename = "AvgDiskBytesPerWrite_Base")]
    pub avg_disk_bytes_per_write__base: Option<u32>,
...
/// 
    ...
    pub avg_disksec_per_read__base: Option<u32>,
...
/// 
    #[serde(rename = "AvgDisksecPerTransfer_Base")]
    pub avg_disksec_per_transfer__base: Option<u32>,
...
/// 
    ...
    pub avg_disksec_per_write__base: Option<u32>,
...
/// 
    #[serde(rename = "PercentDiskReadTime_Base")]
    pub percent_disk_read_time__base: Option<u64>,
...
/// 
    #[serde(rename = "PercentDiskTime_Base")]
    pub percent_disk_time__base: Option<u64>,
...
/// 
    #[serde(rename = "PercentDiskWriteTime_Base")]
    pub percent_disk_write_time__base: Option<u64>,
...
/// 
    #[serde(rename = "PercentFreeSpace_Base")]
    pub percent_free_space__base: Option<u32>,
...
/// 
    #[serde(rename = "PercentIdleTime_Base")]
    pub percent_idle_time__base: Option<u64>,
...
impl Win32_PerfRawData_PerfDisk_LogicalDisk {
    /// Creates a new instance of the struct
    pub fn new() -> Self {
        Self {
            base: Win32_PerfRawData::new(),
            avg_disk_bytes_per_read: None,
            avg_disk_bytes_per_read__base: None,
            avg_disk_bytes_per_transfer: None,
            avg_disk_bytes_per_transfer__base: None,
            avg_disk_bytes_per_write: None,
            avg_disk_bytes_per_write__base: None,
            avg_disk_queue_length: None,
            avg_disk_read_queue_length: None,
            avg_disksec_per_read: None,
            avg_disksec_per_read__base: None,
            avg_disksec_per_transfer: None,
            avg_disksec_per_transfer__base: None,
            avg_disksec_per_write: None,
            avg_disksec_per_write__base: None,
            ...
            percent_disk_read_time__base: None,
            percent_disk_time: None,
            percent_disk_time__base: None,
            percent_disk_write_time: None,
            percent_disk_write_time__base: None,
            percent_free_space: None,
            percent_free_space__base: None,
            percent_idle_time: None,
            percent_idle_time__base: None,
    ...
    /// Sets the value of AvgDiskBytesPerRead_Base
    pub fn set_avg_disk_bytes_per_read__base(&mut self, value: u32) {
        self.avg_disk_bytes_per_read__base = Some(value);
    }

    /// Gets the value of AvgDiskBytesPerRead_Base
    pub fn get_avg_disk_bytes_per_read__base(&self) -> Option<&u32> {
        self.avg_disk_bytes_per_read__base.as_ref()
    }
    ...
    /// Sets the value of AvgDiskBytesPerTransfer_Base
    pub fn set_avg_disk_bytes_per_transfer__base(&mut self, value: u32) {
        self.avg_disk_bytes_per_transfer__base = Some(value);
    }

    /// Gets the value of AvgDiskBytesPerTransfer_Base
    pub fn get_avg_disk_bytes_per_transfer__base(&self) -> Option<&u32> {
        self.avg_disk_bytes_per_transfer__base.as_ref()
    }
    ...
    /// Sets the value of AvgDiskBytesPerWrite_Base
    pub fn set_avg_disk_bytes_per_write__base(&mut self, value: u32) {
        self.avg_disk_bytes_per_write__base = Some(value);
    }

    /// Gets the value of AvgDiskBytesPerWrite_Base
    pub fn get_avg_disk_bytes_per_write__base(&self) -> Option<&u32> {
        self.avg_disk_bytes_per_write__base.as_ref()
    }
    ...
    /// Sets the value of AvgDisksecPerRead_Base
    pub fn set_avg_disksec_per_read__base(&mut self, value: u32) {
        self.avg_disksec_per_read__base = Some(value);
    }

    /// Gets the value of AvgDisksecPerRead_Base
    pub fn get_avg_disksec_per_read__base(&self) -> Option<&u32> {
        self.avg_disksec_per_read__base.as_ref()
    }
    ...
    /// Sets the value of AvgDisksecPerTransfer_Base
    pub fn set_avg_disksec_per_transfer__base(&mut self, value: u32) {
        self.avg_disksec_per_transfer__base = Some(value);
    }

    /// Gets the value of AvgDisksecPerTransfer_Base
    pub fn get_avg_disksec_per_transfer__base(&self) -> Option<&u32> {
        self.avg_disksec_per_transfer__base.as_ref()
    }
    ...
    /// Sets the value of AvgDisksecPerWrite_Base
    pub fn set_avg_disksec_per_write__base(&mut self, value: u32) {
        self.avg_disksec_per_write__base = Some(value);
    }

    /// Gets the value of AvgDisksecPerWrite_Base
    pub fn get_avg_disksec_per_write__base(&self) -> Option<&u32> {
        self.avg_disksec_per_write__base.as_ref()
    }
    ...
    /// Sets the value of PercentDiskReadTime_Base
    pub fn set_percent_disk_read_time__base(&mut self, value: u64) {
        self.percent_disk_read_time__base = Some(value);
    }

    /// Gets the value of PercentDiskReadTime_Base
    pub fn get_percent_disk_read_time__base(&self) -> Option<&u64> {
        self.percent_disk_read_time__base.as_ref()
    }
    ...
    /// Sets the value of PercentDiskTime_Base
    pub fn set_percent_disk_time__base(&mut self, value: u64) {
        self.percent_disk_time__base = Some(value);
    }

    /// Gets the value of PercentDiskTime_Base
    pub fn get_percent_disk_time__base(&self) -> Option<&u64> {
        self.percent_disk_time__base.as_ref()
    }
    ...
    /// Sets the value of PercentDiskWriteTime_Base
    pub fn set_percent_disk_write_time__base(&mut self, value: u64) {
        self.percent_disk_write_time__base = Some(value);
    }

    /// Gets the value of PercentDiskWriteTime_Base
    pub fn get_percent_disk_write_time__base(&self) -> Option<&u64> {
        self.percent_disk_write_time__base.as_ref()
    }
    ...
    /// Sets the value of PercentFreeSpace_Base
    pub fn set_percent_free_space__base(&mut self, value: u32) {
        self.percent_free_space__base = Some(value);
    }

    /// Gets the value of PercentFreeSpace_Base
    pub fn get_percent_free_space__base(&self) -> Option<&u32> {
        self.percent_free_space__base.as_ref()
    }
    ...
    /// Sets the value of PercentIdleTime_Base
    pub fn set_percent_idle_time__base(&mut self, value: u64) {
        self.percent_idle_time__base = Some(value);
    }

    /// Gets the value of PercentIdleTime_Base
    pub fn get_percent_idle_time__base(&self) -> Option<&u64> {
        self.percent_idle_time__base.as_ref()
    }
