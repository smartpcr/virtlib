...
pub struct Win32_PerfRawData_NETFramework_NETCLRJit {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "PercentTimeinJit_Base")]
    pub percent_timein_jit__base: Option<u32>,
...
impl Win32_PerfRawData_NETFramework_NETCLRJit {
    ...
    /// Sets the value of PercentTimeinJit_Base
    pub fn set_percent_timein_jit__base(&mut self, value: u32) {
        self.percent_timein_jit__base = Some(value);
    }

    /// Gets the value of PercentTimeinJit_Base
    pub fn get_percent_timein_jit__base(&self) -> Option<&u32> {
        self.percent_timein_jit__base.as_ref()
    }
