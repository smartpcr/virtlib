...
pub struct Win32_PerfRawData_CsvVolumePerfProvider_ClusterCSVVolumeCache {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "PercentCacheValid_Base")]
    pub percent_cache_valid__base: Option<u64>,
...
impl Win32_PerfRawData_CsvVolumePerfProvider_ClusterCSVVolumeCache {
    ...
    pub fn new() -> Self {
        Self {
            ...
            percent_cache_valid__base: None,
    ...
    /// Sets the value of PercentCacheValid_Base
    pub fn set_percent_cache_valid__base(&mut self, value: u64) {
        self.percent_cache_valid__base = Some(value);
    }

    /// Gets the value of PercentCacheValid_Base
    pub fn get_percent_cache_valid__base(&self) -> Option<&u64> {
        self.percent_cache_valid__base.as_ref()
    }
