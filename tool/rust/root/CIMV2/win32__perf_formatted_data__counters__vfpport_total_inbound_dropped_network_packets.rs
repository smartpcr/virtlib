...
pub struct Win32_PerfFormattedData_Counters_VFPPortTotalInboundDroppedNetworkPackets {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_Counters_VFPPortTotalInboundDroppedNetworkPackets {
