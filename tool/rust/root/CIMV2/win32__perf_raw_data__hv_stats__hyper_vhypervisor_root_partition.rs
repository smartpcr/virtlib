...
pub struct Win32_PerfRawData_HvStats_HyperVHypervisorRootPartition {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "IOTLBFlushCost_Base")]
    pub iotlbflush_cost__base: Option<u64>,
...
impl Win32_PerfRawData_HvStats_HyperVHypervisorRootPartition {
    ...
    /// Sets the value of IOTLBFlushCost_Base
    pub fn set_iotlbflush_cost__base(&mut self, value: u64) {
        self.iotlbflush_cost__base = Some(value);
    }

    /// Gets the value of IOTLBFlushCost_Base
    pub fn get_iotlbflush_cost__base(&self) -> Option<&u64> {
        self.iotlbflush_cost__base.as_ref()
    }
