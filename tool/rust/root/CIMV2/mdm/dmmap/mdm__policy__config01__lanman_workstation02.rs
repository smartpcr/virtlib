...
pub struct MDM_Policy_Config01_LanmanWorkstation02 {

/// 
    #[serde(rename = "EnableInsecureGuestLogons")]
    pub enable_insecure_guest_logons: Option<i32>,
...
impl MDM_Policy_Config01_LanmanWorkstation02 {
    ...
    pub fn set_enable_insecure_guest_logons(&mut self, value: i32) {
        self.enable_insecure_guest_logons = Some(value);
    }

    /// Gets the value of EnableInsecureGuestLogons
    pub fn get_enable_insecure_guest_logons(&self) -> Option<&i32> {
