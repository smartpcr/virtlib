...
/// 
    #[serde(rename = "RequireVpnClientAppUI")]
    pub require_vpn_client_app_ui: Option<bool>,
...
impl MDM_VPNv2_User_01 {
    ...
    pub fn new() -> Self {
        Self {
            ...
            require_vpn_client_app_ui: None,
    ...
    /// Sets the value of RequireVpnClientAppUI
    pub fn set_require_vpn_client_app_ui(&mut self, value: bool) {
        self.require_vpn_client_app_ui = Some(value);
    }

    /// Gets the value of RequireVpnClientAppUI
    pub fn get_require_vpn_client_app_ui(&self) -> Option<&bool> {
        self.require_vpn_client_app_ui.as_ref()
    }
