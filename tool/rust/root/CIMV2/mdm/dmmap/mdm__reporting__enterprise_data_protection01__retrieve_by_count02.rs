...
pub struct MDM_Reporting_EnterpriseDataProtection01_RetrieveByCount02 {
...
impl MDM_Reporting_EnterpriseDataProtection01_RetrieveByCount02 {
    ...
    /// Sets the value of LogCount
    pub fn set_log_count(&mut self, value: i32) {
        self.log_count = Some(value);
    }

    /// Gets the value of LogCount
    pub fn get_log_count(&self) -> Option<&i32> {
        self.log_count.as_ref()
    }
