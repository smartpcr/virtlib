...
pub struct MDM_Policy_Result01_InternetExplorer02 {
...
/// 
    #[serde(rename = "AllowFallbackToSSL3")]
    pub allow_fallback_to_ssl3: Option<String>,
...
/// 
    ...
    pub disable_update_check: Option<String>,
...
/// 
    #[serde(rename = "DoNotAllowUsersToAddSites")]
    pub do_not_allow_users_to_add_sites: Option<String>,

/// 
    #[serde(rename = "DoNotAllowUsersToChangePolicies")]
    pub do_not_allow_users_to_change_policies: Option<String>,
...
/// 
    #[serde(rename = "SecurityZonesUseOnlyMachineSettings")]
    pub security_zones_use_only_machine_settings: Option<String>,
...
impl MDM_Policy_Result01_InternetExplorer02 {
    ...
    pub fn new() -> Self {
        Self {
            ...
            do_not_allow_users_to_add_sites: None,
            do_not_allow_users_to_change_policies: None,
            ...
            security_zones_use_only_machine_settings: None,
    ...
    /// Sets the value of AllowFallbackToSSL3
    pub fn set_allow_fallback_to_ssl3(&mut self, value: String) {
        self.allow_fallback_to_ssl3 = Some(value);
    }

    /// Gets the value of AllowFallbackToSSL3
    pub fn get_allow_fallback_to_ssl3(&self) -> Option<&String> {
        self.allow_fallback_to_ssl3.as_ref()
    }
    ...
    /// Sets the value of DisableUpdateCheck
    pub fn set_disable_update_check(&mut self, value: String) {
        self.disable_update_check = Some(value);
    }

    /// Gets the value of DisableUpdateCheck
    pub fn get_disable_update_check(&self) -> Option<&String> {
        self.disable_update_check.as_ref()
    }
    ...
    /// Sets the value of DoNotAllowUsersToAddSites
    pub fn set_do_not_allow_users_to_add_sites(&mut self, value: String) {
        self.do_not_allow_users_to_add_sites = Some(value);
    }

    /// Gets the value of DoNotAllowUsersToAddSites
    pub fn get_do_not_allow_users_to_add_sites(&self) -> Option<&String> {
        self.do_not_allow_users_to_add_sites.as_ref()
    }

    /// Sets the value of DoNotAllowUsersToChangePolicies
    pub fn set_do_not_allow_users_to_change_policies(&mut self, value: String) {
        self.do_not_allow_users_to_change_policies = Some(value);
    }

    /// Gets the value of DoNotAllowUsersToChangePolicies
    pub fn get_do_not_allow_users_to_change_policies(&self) -> Option<&String> {
        self.do_not_allow_users_to_change_policies.as_ref()
    }
    ...
    /// Sets the value of SecurityZonesUseOnlyMachineSettings
    pub fn set_security_zones_use_only_machine_settings(&mut self, value: String) {
        self.security_zones_use_only_machine_settings = Some(value);
    }

    /// Gets the value of SecurityZonesUseOnlyMachineSettings
    pub fn get_security_zones_use_only_machine_settings(&self) -> Option<&String> {
        self.security_zones_use_only_machine_settings.as_ref()
    }
