...
pub struct MDM_Policy_Config01_MixedReality02 {
...
/// 
    #[serde(rename = "AllowLaunchUriInSingleAppKiosk")]
    pub allow_launch_uri_in_single_app_kiosk: Option<i32>,
...
/// 
    #[serde(rename = "ConfigureMovingPlatform")]
    pub configure_moving_platform: Option<i32>,
...
/// 
    #[serde(rename = "ManualDownDirectionDisabled")]
    pub manual_down_direction_disabled: Option<i32>,
...
impl MDM_Policy_Config01_MixedReality02 {
    ...
    /// Sets the value of AllowLaunchUriInSingleAppKiosk
    pub fn set_allow_launch_uri_in_single_app_kiosk(&mut self, value: i32) {
        self.allow_launch_uri_in_single_app_kiosk = Some(value);
    }

    /// Gets the value of AllowLaunchUriInSingleAppKiosk
    pub fn get_allow_launch_uri_in_single_app_kiosk(&self) -> Option<&i32> {
        self.allow_launch_uri_in_single_app_kiosk.as_ref()
    }
    ...
    /// Sets the value of ConfigureMovingPlatform
    pub fn set_configure_moving_platform(&mut self, value: i32) {
        self.configure_moving_platform = Some(value);
    }

    /// Gets the value of ConfigureMovingPlatform
    pub fn get_configure_moving_platform(&self) -> Option<&i32> {
        self.configure_moving_platform.as_ref()
    }
    ...
    /// Sets the value of ManualDownDirectionDisabled
    pub fn set_manual_down_direction_disabled(&mut self, value: i32) {
        self.manual_down_direction_disabled = Some(value);
    }

    /// Gets the value of ManualDownDirectionDisabled
    pub fn get_manual_down_direction_disabled(&self) -> Option<&i32> {
        self.manual_down_direction_disabled.as_ref()
    }
