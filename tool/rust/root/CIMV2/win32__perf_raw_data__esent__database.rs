...
pub struct Win32_PerfRawData_ESENT_Database {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "DatabaseCachePercentDehydrated_Base")]
    pub database_cache_percent_dehydrated__base: Option<u32>,
...
impl Win32_PerfRawData_ESENT_Database {
    ...
    pub fn new() -> Self {
        Self {
            ...
            database_cache_percent_dehydrated__base: None,
    ...
    /// Sets the value of DatabaseCachePercentDehydrated_Base
    pub fn set_database_cache_percent_dehydrated__base(&mut self, value: u32) {
        self.database_cache_percent_dehydrated__base = Some(value);
    }

    /// Gets the value of DatabaseCachePercentDehydrated_Base
    pub fn get_database_cache_percent_dehydrated__base(&self) -> Option<&u32> {
        self.database_cache_percent_dehydrated__base.as_ref()
    }
