...
impl CIM_Process {
    ...
    pub fn set_termination_date(&mut self, value: String) {
        self.termination_date = Some(value);
    }

    /// Gets the value of TerminationDate
    pub fn get_termination_date(&self) -> Option<&String> {
