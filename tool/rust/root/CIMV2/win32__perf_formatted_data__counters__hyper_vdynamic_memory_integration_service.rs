...
pub struct Win32_PerfFormattedData_Counters_HyperVDynamicMemoryIntegrationService {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_Counters_HyperVDynamicMemoryIntegrationService {
