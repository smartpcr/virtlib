...
pub struct Win32_PerfFormattedData_Counters_VFPPortTotalOutboundDroppedNetworkPackets {
    #[serde(flatten)]
...
impl Win32_PerfFormattedData_Counters_VFPPortTotalOutboundDroppedNetworkPackets {
