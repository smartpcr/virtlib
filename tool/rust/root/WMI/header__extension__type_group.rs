...
pub struct Header_Extension_TypeGroup {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "KernelEventVersion")]
    pub kernel_event_version: Option<u32>,
}

impl Header_Extension_TypeGroup {
    ...
    /// Sets the value of KernelEventVersion
    pub fn set_kernel_event_version(&mut self, value: u32) {
        self.kernel_event_version = Some(value);
    }

    /// Gets the value of KernelEventVersion
    pub fn get_kernel_event_version(&self) -> Option<&u32> {
        self.kernel_event_version.as_ref()
    }
}
