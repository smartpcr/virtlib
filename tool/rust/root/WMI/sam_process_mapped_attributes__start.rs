...
pub struct SamProcessMappedAttributes_Start {
    #[serde(flatten)]
    pub base: SamProcessMappedAttributes,
...
impl SamProcessMappedAttributes_Start {
    /// Creates a new instance of the struct
    pub fn new() -> Self {
        Self {
            base: SamProcessMappedAttributes::new(),
            client: None,
            sam: None,
            sid: None,
            version: None,
