...
impl FileIo_V2_DirEnum {
    ...
    /// Sets the value of FileIndex
    pub fn set_file_index(&mut self, value: u32) {
        self.file_index = Some(value);
    }

    /// Gets the value of FileIndex
    pub fn get_file_index(&self) -> Option<&u32> {
