...
pub struct MSNdis_WmiTcpIpChecksumOffload_IPv4TransmitReceive {
    #[serde(flatten)]
    pub base: MSNdis,
...
/// 
    #[serde(rename = "IpChecksum")]
    pub ip_checksum: Option<u32>,

/// 
    #[serde(rename = "IpOptionsSupported")]
    pub ip_options_supported: Option<u32>,
...
impl MSNdis_WmiTcpIpChecksumOffload_IPv4TransmitReceive {
    ...
    /// Sets the value of IpChecksum
    pub fn set_ip_checksum(&mut self, value: u32) {
        self.ip_checksum = Some(value);
    }

    /// Gets the value of IpChecksum
    pub fn get_ip_checksum(&self) -> Option<&u32> {
        self.ip_checksum.as_ref()
    }

    /// Sets the value of IpOptionsSupported
    pub fn set_ip_options_supported(&mut self, value: u32) {
        self.ip_options_supported = Some(value);
    }

    /// Gets the value of IpOptionsSupported
    pub fn get_ip_options_supported(&self) -> Option<&u32> {
        self.ip_options_supported.as_ref()
    }
