...
pub struct SystemConfig_V3_IRQ {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "IRQGroup")]
    pub irqgroup: Option<u16>,
...
impl SystemConfig_V3_IRQ {
    ...
    /// Sets the value of IRQGroup
    pub fn set_irqgroup(&mut self, value: u16) {
        self.irqgroup = Some(value);
    }

    /// Gets the value of IRQGroup
    pub fn get_irqgroup(&self) -> Option<&u16> {
        self.irqgroup.as_ref()
    }
