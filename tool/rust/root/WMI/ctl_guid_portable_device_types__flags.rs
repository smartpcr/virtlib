...
//      Source CtlGuidPortableDeviceTypes_Flags
//////////////////////////////////////////////

/// CtlGuidPortableDeviceTypes_Flags enumeration
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, serde::Serialize, serde::Deserialize)]
#[repr(i32)]
pub enum CtlGuidPortableDeviceTypes_Flags {
    ...
    #[serde(rename = "WPD_F8")]
    WPDF8 = 16,
    /// PortableDeviceTypes_General
    #[serde(rename = "PortableDeviceTypes_General")]
    PortableDeviceTypesGeneral = 17,
    /// PortableDeviceTypes_Serialization
    #[serde(rename = "PortableDeviceTypes_Serialization")]
    PortableDeviceTypesSerialization = 18,
    /// PortableDeviceTypes_Collections
    #[serde(rename = "PortableDeviceTypes_Collections")]
    PortableDeviceTypesCollections = 19,
    /// PortableDeviceTypes_Values
    #[serde(rename = "PortableDeviceTypes_Values")]
    PortableDeviceTypesValues = 20,
}

impl Default for CtlGuidPortableDeviceTypes_Flags {
    fn default() -> Self {
