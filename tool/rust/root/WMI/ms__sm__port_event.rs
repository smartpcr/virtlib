...
/// 
    #[serde(rename = "FabricPortId")]
    pub fabric_port_id: Option<u32>,
...
impl MS_SM_PortEvent {
    ...
    /// Sets the value of FabricPortId
    pub fn set_fabric_port_id(&mut self, value: u32) {
        self.fabric_port_id = Some(value);
    }

    /// Gets the value of FabricPortId
    pub fn get_fabric_port_id(&self) -> Option<&u32> {
        self.fabric_port_id.as_ref()
    }
