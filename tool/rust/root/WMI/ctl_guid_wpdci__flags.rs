...
//      Source CtlGuidWPDCI_Flags
//////////////////////////////////////////////

/// CtlGuidWPDCI_Flags enumeration
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, serde::Serialize, serde::Deserialize)]
#[repr(i32)]
pub enum CtlGuidWPDCI_Flags {
    ...
    WPDF8 = 16,
    /// WPDCI_feature1
    #[serde(rename = "WPDCI_feature1")]
    WPDCIFeature1 = 17,
    /// WPDCI_feature2
    #[serde(rename = "WPDCI_feature2")]
    WPDCIFeature2 = 18,
}

impl Default for CtlGuidWPDCI_Flags {
    fn default() -> Self {
