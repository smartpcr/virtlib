...
pub struct Thread_V1_TypeGroup1 {
    #[serde(flatten)]
    pub base: Thread_V1,
...
impl Thread_V1_TypeGroup1 {
    ...
    pub fn set_wait_mode(&mut self, value: u8) {
        self.wait_mode = Some(value);
    }

    /// Gets the value of WaitMode
    pub fn get_wait_mode(&self) -> Option<&u8> {
