...
pub struct MSiSCSI_InitiatorSessionInfo {
...
/// Variable length array of sessions.  SessionCount specifies the number of elements in the array. NOTE: this is a variable length array.
    ...
    pub sessions_list: Vec<ISCSI_SessionStaticInfo>,
...
impl MSiSCSI_InitiatorSessionInfo {
    ...
    /// Sets the value of SessionsList
    pub fn set_sessions_list(&mut self, value: Vec<ISCSI_SessionStaticInfo>) {
        self.sessions_list = value;
    }

    /// Gets the value of SessionsList
    pub fn get_sessions_list(&self) -> &Vec<ISCSI_SessionStaticInfo> {
        &self.sessions_list
    }
