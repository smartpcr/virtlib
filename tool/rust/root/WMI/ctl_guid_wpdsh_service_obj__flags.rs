...
//      Source CtlGuidWPDShServiceObj_Flags
//////////////////////////////////////////////

/// CtlGuidWPDShServiceObj_Flags enumeration
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, serde::Serialize, serde::Deserialize)]
#[repr(i32)]
pub enum CtlGuidWPDShServiceObj_Flags {
    ...
    WPDF8 = 16,
    /// WPDShServiceObj_f1
    #[serde(rename = "WPDShServiceObj_f1")]
    WPDShServiceObjF1 = 17,
    /// WPDShServiceObj_f2
    #[serde(rename = "WPDShServiceObj_f2")]
    WPDShServiceObjF2 = 18,
}

impl Default for CtlGuidWPDShServiceObj_Flags {
    fn default() -> Self {
