...
pub struct MSNdis_ReceiveQueueInfo {
    #[serde(flatten)]
    pub base: MSNdis,
...
impl MSNdis_ReceiveQueueInfo {
    ...
    /// Sets the value of QueueState
    pub fn set_queue_state(&mut self, value: u32) {
        self.queue_state = Some(value);
    }

    /// Gets the value of QueueState
    pub fn get_queue_state(&self) -> Option<&u32> {
