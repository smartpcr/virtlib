...
/// 
    #[serde(rename = "UmsApcControlFlags")]
    pub ums_apc_control_flags: Option<u32>,
}

impl UmsDisassociate {
    ...
    /// Sets the value of UmsApcControlFlags
    pub fn set_ums_apc_control_flags(&mut self, value: u32) {
        self.ums_apc_control_flags = Some(value);
    }

    /// Gets the value of UmsApcControlFlags
    pub fn get_ums_apc_control_flags(&self) -> Option<&u32> {
        self.ums_apc_control_flags.as_ref()
    }
}
