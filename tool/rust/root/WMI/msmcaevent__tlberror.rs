...
pub struct MSMCAEvent_TLBError {
    #[serde(flatten)]
    pub base: WMIEvent,
...
/// 
    ...
    pub error_severity: Option<TLBError_ErrorSeverity>,
...
/// 
    ...
    pub memory_hierarchy_level: Option<TLBError_MemoryHierarchyLevel>,
...
/// 
    ...
    pub transaction_type: Option<TLBError_TransactionType>,

/// 
    #[serde(rename = "Type")]
    pub type: Option<TLBError_Type>,
}

impl MSMCAEvent_TLBError {
    ...
    pub fn set_error_severity(&mut self, value: TLBError_ErrorSeverity) {
        self.error_severity = Some(value);
    }

    /// Gets the value of ErrorSeverity
    pub fn get_error_severity(&self) -> Option<&TLBError_ErrorSeverity> {
    ...
    pub fn set_memory_hierarchy_level(&mut self, value: TLBError_MemoryHierarchyLevel) {
        self.memory_hierarchy_level = Some(value);
    }

    /// Gets the value of MemoryHierarchyLevel
    pub fn get_memory_hierarchy_level(&self) -> Option<&TLBError_MemoryHierarchyLevel> {
    ...
    pub fn set_transaction_type(&mut self, value: TLBError_TransactionType) {
        self.transaction_type = Some(value);
    }

    /// Gets the value of TransactionType
    pub fn get_transaction_type(&self) -> Option<&TLBError_TransactionType> {
        self.transaction_type.as_ref()
    }

    /// Sets the value of Type
    pub fn set_type(&mut self, value: TLBError_Type) {
        self.type = Some(value);
    }

    /// Gets the value of Type
    pub fn get_type(&self) -> Option<&TLBError_Type> {
        self.type.as_ref()
    }
}
