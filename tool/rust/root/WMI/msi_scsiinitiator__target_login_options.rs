...
pub struct MSiSCSIInitiator_TargetLoginOptions {
...
/// 
    ...
    pub data_digest: Option<TargetLoginOptions_DataDigest>,
...
/// 
    ...
    pub header_digest: Option<TargetLoginOptions_HeaderDigest>,
...
impl MSiSCSIInitiator_TargetLoginOptions {
    ...
    pub fn set_data_digest(&mut self, value: TargetLoginOptions_DataDigest) {
        self.data_digest = Some(value);
    }

    /// Gets the value of DataDigest
    pub fn get_data_digest(&self) -> Option<&TargetLoginOptions_DataDigest> {
    ...
    pub fn set_header_digest(&mut self, value: TargetLoginOptions_HeaderDigest) {
        self.header_digest = Some(value);
    }

    /// Gets the value of HeaderDigest
    pub fn get_header_digest(&self) -> Option<&TargetLoginOptions_HeaderDigest> {
