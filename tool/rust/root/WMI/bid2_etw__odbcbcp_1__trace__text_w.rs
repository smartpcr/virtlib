...
/// Bid2Etw_ODBCBCP_1_Trace_TextW struct
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
pub struct Bid2Etw_ODBCBCP_1_Trace_TextW {
    #[serde(flatten)]
    pub base: Bid2Etw_ODBCBCP_1_Trace,
...
impl Bid2Etw_ODBCBCP_1_Trace_TextW {
    /// Creates a new instance of the struct
    pub fn new() -> Self {
        Self {
            base: Bid2Etw_ODBCBCP_1_Trace::new(),
            mod_id: None,
            msg_str: None,
        }
    }
