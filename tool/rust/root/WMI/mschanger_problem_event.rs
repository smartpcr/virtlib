...
pub struct MSChangerProblemEvent {
    #[serde(flatten)]
    pub base: WMIEvent,
...
/// 
    #[serde(rename = "ChangerData")]
    pub changer_data: Vec<u8>,
...
impl MSChangerProblemEvent {
    /// Creates a new instance of the struct
    pub fn new() -> Self {
        Self {
            base: WMIEvent::new(),
            active: None,
            changer_data: Vec::new(),
    ...
    /// Sets the value of ChangerData
    pub fn set_changer_data(&mut self, value: Vec<u8>) {
        self.changer_data = value;
    }

    /// Gets the value of ChangerData
    pub fn get_changer_data(&self) -> &Vec<u8> {
        &self.changer_data
    }
