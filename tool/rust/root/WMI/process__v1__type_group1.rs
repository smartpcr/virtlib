...
/// 
    #[serde(rename = "PageDirectoryBase")]
    pub page_directory_base: Option<u32>,
...
impl Process_V1_TypeGroup1 {
    ...
    /// Sets the value of PageDirectoryBase
    pub fn set_page_directory_base(&mut self, value: u32) {
        self.page_directory_base = Some(value);
    }

    /// Gets the value of PageDirectoryBase
    pub fn get_page_directory_base(&self) -> Option<&u32> {
        self.page_directory_base.as_ref()
    }
