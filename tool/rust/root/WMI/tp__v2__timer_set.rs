...
impl TP_V2_TimerSet {
    ...
    /// Sets the value of Absolute
    pub fn set_absolute(&mut self, value: u32) {
        self.absolute = Some(value);
    }

    /// Gets the value of Absolute
    pub fn get_absolute(&self) -> Option<&u32> {
