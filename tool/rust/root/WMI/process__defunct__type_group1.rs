...
pub struct Process_Defunct_TypeGroup1 {
    #[serde(flatten)]
    pub base: Process,
...
impl Process_Defunct_TypeGroup1 {
    ...
    /// Sets the value of ExitTime
    pub fn set_exit_time(&mut self, value: u64) {
        self.exit_time = Some(value);
    }

    /// Gets the value of ExitTime
    pub fn get_exit_time(&self) -> Option<&u64> {
        self.exit_time.as_ref()
    }
