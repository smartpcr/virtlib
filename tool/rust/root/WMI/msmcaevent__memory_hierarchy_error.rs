...
pub struct MSMCAEvent_MemoryHierarchyError {
    #[serde(flatten)]
    pub base: WMIEvent,
...
/// 
    ...
    pub error_severity: Option<MemoryHierarchyError_ErrorSeverity>,
...
/// 
    ...
    pub memory_hierarchy_level: Option<MemoryHierarchyError_MemoryHierarchyLevel>,
...
/// 
    ...
    pub request_type: Option<MemoryHierarchyError_RequestType>,
...
/// 
    ...
    pub transaction_type: Option<MemoryHierarchyError_TransactionType>,

/// 
    #[serde(rename = "Type")]
    pub type: Option<MemoryHierarchyError_Type>,
}

impl MSMCAEvent_MemoryHierarchyError {
    ...
    pub fn set_error_severity(&mut self, value: MemoryHierarchyError_ErrorSeverity) {
        self.error_severity = Some(value);
    }

    /// Gets the value of ErrorSeverity
    pub fn get_error_severity(&self) -> Option<&MemoryHierarchyError_ErrorSeverity> {
    ...
    pub fn set_memory_hierarchy_level(&mut self, value: MemoryHierarchyError_MemoryHierarchyLevel) {
        self.memory_hierarchy_level = Some(value);
    }

    /// Gets the value of MemoryHierarchyLevel
    pub fn get_memory_hierarchy_level(&self) -> Option<&MemoryHierarchyError_MemoryHierarchyLevel> {
    ...
    pub fn set_request_type(&mut self, value: MemoryHierarchyError_RequestType) {
        self.request_type = Some(value);
    }

    /// Gets the value of RequestType
    pub fn get_request_type(&self) -> Option<&MemoryHierarchyError_RequestType> {
    ...
    /// Sets the value of TransactionType
    pub fn set_transaction_type(&mut self, value: MemoryHierarchyError_TransactionType) {
        self.transaction_type = Some(value);
    }

    /// Gets the value of TransactionType
    pub fn get_transaction_type(&self) -> Option<&MemoryHierarchyError_TransactionType> {
        self.transaction_type.as_ref()
    }

    /// Sets the value of Type
    pub fn set_type(&mut self, value: MemoryHierarchyError_Type) {
        self.type = Some(value);
    }

    /// Gets the value of Type
    pub fn get_type(&self) -> Option<&MemoryHierarchyError_Type> {
        self.type.as_ref()
    }
}
