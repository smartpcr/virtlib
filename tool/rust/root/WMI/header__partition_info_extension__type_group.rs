...
pub struct Header_PartitionInfoExtension_TypeGroup {
    #[serde(flatten)]
...
/// 
    ...
    pub partition_id: Option<serde_json::Value>,
...
impl Header_PartitionInfoExtension_TypeGroup {
    ...
    pub fn set_parent_id(&mut self, value: serde_json::Value) {
        self.parent_id = Some(value);
    }

    /// Gets the value of ParentId
    pub fn get_parent_id(&self) -> Option<&serde_json::Value> {
        self.parent_id.as_ref()
    }

    /// Sets the value of PartitionId
    pub fn set_partition_id(&mut self, value: serde_json::Value) {
        self.partition_id = Some(value);
    }

    /// Gets the value of PartitionId
    pub fn get_partition_id(&self) -> Option<&serde_json::Value> {
