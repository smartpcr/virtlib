...
pub struct MSNdis_FddiShortMulticastList {
    #[serde(flatten)]
    pub base: MSNdis,
...
/// 
    ...
    pub ndis_multicast_list: Vec<MSNdis_NetworkShortAddress>,
...
impl MSNdis_FddiShortMulticastList {
    ...
    pub fn set_ndis_multicast_list(&mut self, value: Vec<MSNdis_NetworkShortAddress>) {
        self.ndis_multicast_list = value;
    }

    /// Gets the value of NdisMulticastList
    pub fn get_ndis_multicast_list(&self) -> &Vec<MSNdis_NetworkShortAddress> {
