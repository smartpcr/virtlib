...
pub struct MSNdis_PMAdminConfigParam {
    #[serde(flatten)]
    pub base: MSNdis,

/// 
    #[serde(rename = "DeviceSleepOnDisconnect")]
    pub device_sleep_on_disconnect: Option<MSNdis_PMAdminConfigState>,
...
/// 
    ...
    pub pmarpoffload: Option<MSNdis_PMAdminConfigState>,

/// 
    #[serde(rename = "PMNDOffload")]
    pub pmndoffload: Option<MSNdis_PMAdminConfigState>,

/// 
    #[serde(rename = "PMWiFiRekeyOffload")]
    pub pmwi_fi_rekey_offload: Option<MSNdis_PMAdminConfigState>,

/// 
    #[serde(rename = "WakeOnMagicPacket")]
    pub wake_on_magic_packet: Option<MSNdis_PMAdminConfigState>,

/// 
    #[serde(rename = "WakeOnPattern")]
    pub wake_on_pattern: Option<MSNdis_PMAdminConfigState>,
}

impl MSNdis_PMAdminConfigParam {
    ...
    pub fn set_device_sleep_on_disconnect(&mut self, value: MSNdis_PMAdminConfigState) {
        self.device_sleep_on_disconnect = Some(value);
    }

    /// Gets the value of DeviceSleepOnDisconnect
    pub fn get_device_sleep_on_disconnect(&self) -> Option<&MSNdis_PMAdminConfigState> {
    ...
    pub fn set_pmarpoffload(&mut self, value: MSNdis_PMAdminConfigState) {
        self.pmarpoffload = Some(value);
    }

    /// Gets the value of PMARPOffload
    pub fn get_pmarpoffload(&self) -> Option<&MSNdis_PMAdminConfigState> {
        self.pmarpoffload.as_ref()
    }

    /// Sets the value of PMNDOffload
    pub fn set_pmndoffload(&mut self, value: MSNdis_PMAdminConfigState) {
        self.pmndoffload = Some(value);
    }

    /// Gets the value of PMNDOffload
    pub fn get_pmndoffload(&self) -> Option<&MSNdis_PMAdminConfigState> {
        self.pmndoffload.as_ref()
    }

    /// Sets the value of PMWiFiRekeyOffload
    pub fn set_pmwi_fi_rekey_offload(&mut self, value: MSNdis_PMAdminConfigState) {
        self.pmwi_fi_rekey_offload = Some(value);
    }

    /// Gets the value of PMWiFiRekeyOffload
    pub fn get_pmwi_fi_rekey_offload(&self) -> Option<&MSNdis_PMAdminConfigState> {
        self.pmwi_fi_rekey_offload.as_ref()
    }

    /// Sets the value of WakeOnMagicPacket
    pub fn set_wake_on_magic_packet(&mut self, value: MSNdis_PMAdminConfigState) {
        self.wake_on_magic_packet = Some(value);
    }

    /// Gets the value of WakeOnMagicPacket
    pub fn get_wake_on_magic_packet(&self) -> Option<&MSNdis_PMAdminConfigState> {
        self.wake_on_magic_packet.as_ref()
    }

    /// Sets the value of WakeOnPattern
    pub fn set_wake_on_pattern(&mut self, value: MSNdis_PMAdminConfigState) {
        self.wake_on_pattern = Some(value);
    }

    /// Gets the value of WakeOnPattern
    pub fn get_wake_on_pattern(&self) -> Option<&MSNdis_PMAdminConfigState> {
