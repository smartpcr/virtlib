...
/// 
    #[serde(rename = "State")]
    pub state: Vec<IdleStateAccountingEx>,
...
impl IdleAccountingEx {
    ...
    pub fn set_state(&mut self, value: Vec<IdleStateAccountingEx>) {
        self.state = value;
    }

    /// Gets the value of State
    pub fn get_state(&self) -> &Vec<IdleStateAccountingEx> {
        &self.state
    }
