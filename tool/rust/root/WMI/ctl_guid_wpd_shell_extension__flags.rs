...
//      Source CtlGuidWpdShellExtension_Flags
//////////////////////////////////////////////

/// CtlGuidWpdShellExtension_Flags enumeration
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, serde::Serialize, serde::Deserialize)]
#[repr(i32)]
pub enum CtlGuidWpdShellExtension_Flags {
    ...
    WPDF8 = 16,
    /// WPDNSE_REFCOUNT
    #[serde(rename = "WPDNSE_REFCOUNT")]
    WPDNSEREFCOUNT = 17,
    /// WPDNSE_DLLREFCOUNT
    #[serde(rename = "WPDNSE_DLLREFCOUNT")]
    WPDNSEDLLREFCOUNT = 18,
    /// WPDNSE_CHANGENOTIFY
    #[serde(rename = "WPDNSE_CHANGENOTIFY")]
    WPDNSECHANGENOTIFY = 19,
    /// WPDNSE_TRANSCODE
    #[serde(rename = "WPDNSE_TRANSCODE")]
    WPDNSETRANSCODE = 20,
}

impl Default for CtlGuidWpdShellExtension_Flags {
    fn default() -> Self {
