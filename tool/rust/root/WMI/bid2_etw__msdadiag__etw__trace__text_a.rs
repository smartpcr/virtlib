...
/// Bid2Etw_MSDADIAG_ETW_Trace_TextA struct
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
pub struct Bid2Etw_MSDADIAG_ETW_Trace_TextA {
    #[serde(flatten)]
    pub base: Bid2Etw_MSDADIAG_ETW_Trace,
...
impl Bid2Etw_MSDADIAG_ETW_Trace_TextA {
    /// Creates a new instance of the struct
    pub fn new() -> Self {
        Self {
            base: Bid2Etw_MSDADIAG_ETW_Trace::new(),
            mod_id: None,
            msg_str: None,
        }
    }
