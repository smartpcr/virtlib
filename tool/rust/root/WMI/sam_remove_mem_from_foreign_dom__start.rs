...
pub struct SamRemoveMemFromForeignDom_Start {
    #[serde(flatten)]
    pub base: SamRemoveMemFromForeignDom,
...
impl SamRemoveMemFromForeignDom_Start {
    /// Creates a new instance of the struct
    pub fn new() -> Self {
        Self {
            base: SamRemoveMemFromForeignDom::new(),
            client: None,
            sam: None,
            sid: None,
            version: None,
