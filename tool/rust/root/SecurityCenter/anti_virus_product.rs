...
/// 
    #[serde(rename = "onAccessScanningEnabled")]
    pub on_access_scanning_enabled: Option<bool>,
...
impl AntiVirusProduct {
    ...
    pub fn new() -> Self {
        Self {
            ...
            display_name: None,
            instance_guid: None,
            on_access_scanning_enabled: None,
    ...
    /// Sets the value of onAccessScanningEnabled
    pub fn set_on_access_scanning_enabled(&mut self, value: bool) {
        self.on_access_scanning_enabled = Some(value);
    }

    /// Gets the value of onAccessScanningEnabled
    pub fn get_on_access_scanning_enabled(&self) -> Option<&bool> {
        self.on_access_scanning_enabled.as_ref()
    }
