...
pub struct RSOP_FileBlocked {
    #[serde(flatten)]
    pub base: RSOP_SecuritySettingsBlocked,

/// 
    #[serde(rename = "Mode")]
    pub mode: Option<FileBlocked_Mode>,
...
impl RSOP_FileBlocked {
    ...
    pub fn set_mode(&mut self, value: FileBlocked_Mode) {
        self.mode = Some(value);
    }

    /// Gets the value of Mode
    pub fn get_mode(&self) -> Option<&FileBlocked_Mode> {
        self.mode.as_ref()
    }
