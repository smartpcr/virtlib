...
pub struct RSOP_IERegistryPolicySetting {
    #[serde(flatten)]
...
impl RSOP_IERegistryPolicySetting {
    ...
    pub fn set_current_user(&mut self, value: bool) {
        self.current_user = Some(value);
    }

    /// Gets the value of currentUser
    pub fn get_current_user(&self) -> Option<&bool> {
