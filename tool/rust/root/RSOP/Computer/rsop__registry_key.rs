...
pub struct RSOP_RegistryKey {
    #[serde(flatten)]
    pub base: RSOP_SecuritySettings,

/// 
    #[serde(rename = "Mode")]
    pub mode: Option<RegistryKey_Mode>,
...
impl RSOP_RegistryKey {
    ...
    pub fn set_mode(&mut self, value: RegistryKey_Mode) {
        self.mode = Some(value);
    }

    /// Gets the value of Mode
    pub fn get_mode(&self) -> Option<&RegistryKey_Mode> {
        self.mode.as_ref()
    }
