...
pub struct CIM_RegisteredSpecification {
    #[serde(flatten)]
...
/// 
    #[serde(rename = "OtherSpecificationType")]
    pub other_specification_type: Option<String>,
...
/// 
    #[serde(rename = "SpecificationType")]
    pub specification_type: Option<u16>,
}

impl CIM_RegisteredSpecification {
    ...
    /// Sets the value of OtherSpecificationType
    pub fn set_other_specification_type(&mut self, value: String) {
        self.other_specification_type = Some(value);
    }

    /// Gets the value of OtherSpecificationType
    pub fn get_other_specification_type(&self) -> Option<&String> {
        self.other_specification_type.as_ref()
    }
    ...
    /// Sets the value of SpecificationType
    pub fn set_specification_type(&mut self, value: u16) {
        self.specification_type = Some(value);
    }

    /// Gets the value of SpecificationType
    pub fn get_specification_type(&self) -> Option<&u16> {
        self.specification_type.as_ref()
    }
}
