...
pub struct CIM_MetricService {
    #[serde(flatten)]
    pub base: CIM_Service,
}

impl CIM_MetricService {
...
/// If the Subject parameter and Definition parameter are both non-NULL, the method shall return NULL values for the DefinitionList and ManagedElements parameters, and the MetricCollectionEnabled parameter shall contain a single value that corresponds to the value of the MetricCollectionEnabled property of the instance of CIM_MetricDefForME that associates the instance of CIM_ManagedElement identified by the Subject parameter with the instance of CIM_BaseMetricDefinition identified by the Definition parameter. If the Subject and Definition parameters are both NULL, the method shall return 2 "Failed". If the Definition parameter is a reference to an instance of CIM_BaseMetricDefinition that is not associated to the CIM_MetricService through CIM_ServiceAffectsElement, the method shall return 2 "Failed". If the Subject parameter does not identify a single instance the Method shall return 2 "Failed".
    ...
    /// * `definition` - The Definition parameter identifies an instance of CIM_BaseMetricDefintion. The method returns references to instances of CIM_ManagedElement for which metrics defined by the instance of CIM_BaseMetricDefinition are available to be collected. (CIM_BaseMetricDefinition)
    /// * `subject` - The Subject parameter identifies an instance of CIM_ManagedElement for which the method returns references to instances of CIM_BaseMetricDefinition that define metrics that are being captured for the CIM_ManagedElement. (CIM_ManagedElement)

    /// * `definition_list` - Upon successful completion of the method, the DefinitionList parameter may contain references to instances of CIM_BaseMetricDefinitions that define metrics available for collection for the CIM_ManagedElement identified by the Subject parameter. (CIM_BaseMetricDefinition[])
    /// * `managed_elements` - Upon successful completion of the method, the ManagedElements[] parameter may contain references to CIM_ManagedElements for which the metric identified by Definition parameter is available for collection. (CIM_ManagedElement[])
    /// * `metric_collection_enabled` - The MetricCollectionEnabled parameter indicates whether a metric is being collected for a managed element. (MetricService_MetricCollectionEnabled[])
    /// * `metric_names` - Upon successful completion of the method, each array index of the MetricNames parameter shall contain the value of the Name property for the instance of CIM_BaseMetricDefinition referenced by the corresponding array index of the DefinitionList parameter. (String[])
    /// * `return_value` -  (u32)
    pub fn show_metrics(&self, subject: CIM_ManagedElement, definition: CIM_BaseMetricDefinition, managed_elements: &mut Vec<CIM_ManagedElement>, definition_list: &mut Vec<CIM_BaseMetricDefinition>, metric_names: &mut Vec<String>, metric_collection_enabled: &mut Vec<MetricService_MetricCollectionEnabled>) -> Result<(), WmiError> {
        let mut args = Vec::new();
        args.push(MethodParameter { name: "Subject".to_string(), value: subject.into() });
        args.push(MethodParameter { name: "Definition".to_string(), value: definition.into() });

        let result = self.invoke_method("ShowMetrics", &args)?;
        let definition_list = result.get_value("DefinitionList")?;
        let managed_elements = result.get_value("ManagedElements")?;
        let metric_collection_enabled = result.get_value("MetricCollectionEnabled")?;
        let metric_names = result.get_value("MetricNames")?;
...
/// If the Subject parameter and Definition parameter are both non-NULL, the method shall return NULL value for the DefinitionList parameter and the MetricCollectionEnabled parameter shall contain a single value that corresponds to the value of the MetricCollectionEnabled property of the instance of CIM_MetricDefForME that associates the instance of CIM_ManagedElement identified by the Subject parameter with the instance of CIM_BaseMetricDefinition identified by the Definition parameter. If the Subject and Definition parameters are both NULL, the method shall return 2 "Failed". If the Definition parameter is a reference to an instance of CIM_BaseMetricDefinition that is not associated to the CIM_MetricService through CIM_ServiceAffectsElement, the method shall return 2 "Failed". If the Subject parameter does not identify a single CIM Class the Method shall return 2 "Failed".
    ...
    /// * `definition` - The Definition parameter identifies an instance of CIM_BaseMetricDefinition. The method returns references to instances of CIM_ManagedElement for which metrics defined by the instance of CIM_BaseMetricDefinition are available to be collected. (CIM_BaseMetricDefinition)
    /// * `subject` - The Subject parameter identifies a CIM class for which the method returns references to instances of CIM_BaseMetricDefinition that define metrics that are available to be captured for all instances of the class. (CIM_ManagedElement)

    /// * `definition_list` - Upon successful completion of the method, the DefinitionList parameter may contain references to instances of CIM_BaseMetricDefinitions that define metrics available for collection for the CIM_ManagedElement identified by the Subject parameter. (CIM_BaseMetricDefinition[])
    /// * `metric_collection_enabled` - The MetricCollectionEnabled parameter indicates whether a metric is being collected for all instances of a class of managed elements. (MetricService_MetricCollectionEnabled[])
    /// * `metric_names` - Upon successful completion of the method, each array index of the MetricNames parameter shall contain the value of the Name property for the instance of CIM_BaseMetricDefinition referenced by the corresponding array index of the DefinitionList parameter. (String[])
    /// * `return_value` -  (u32)
    pub fn show_metrics_by_class(&self, subject: CIM_ManagedElement, definition: CIM_BaseMetricDefinition, definition_list: &mut Vec<CIM_BaseMetricDefinition>, metric_names: &mut Vec<String>, metric_collection_enabled: &mut Vec<MetricService_MetricCollectionEnabled>) -> Result<(), WmiError> {
        let mut args = Vec::new();
        args.push(MethodParameter { name: "Subject".to_string(), value: subject.into() });
        args.push(MethodParameter { name: "Definition".to_string(), value: definition.into() });

        let result = self.invoke_method("ShowMetricsByClass", &args)?;
        let definition_list = result.get_value("DefinitionList")?;
        let metric_collection_enabled = result.get_value("MetricCollectionEnabled")?;
        let metric_names = result.get_value("MetricNames")?;
        Ok(result.return_value)
...
/// If the Subject parameter and Definition parameter are both non-NULL and the value of the MetricCollectionEnabled parameter is 4 "Reset" upon successful completion of the method, the MetricCollectionEnabled property of the instance of CIM_MetricDefForME that references the instance of CIM_ManagedElement identified by the Subject parameter and references the instance of CIM_BaseMetricDefinition identified by the Definition parameter shall transition to 3 "Disabled" then to 2 "Enabled". If the Subject parameter and Definition parameter are both non-NULL and there is not an instance of CIM_MetricDefForME that associates the two instances, the method shall return 2 "Failed". If the Subject and Definition parameters are both NULL, the method shall return 2 "Failed". If the Definition parameter is a reference to an instance of CIM_BaseMetricDefinition that is not associated to the CIM_MetricService through CIM_ServiceAffectsElement, the method shall return 2 "Failed". If the Subject parameter does not identify a single instance the Method shall return 2 "Failed".
    ...
    /// * `definition` - The Definition parameter identifies a CIM_BaseMetricDefinition for which metrics will be controlled. (CIM_BaseMetricDefinition)
    /// * `metric_collection_enabled` - The MetricCollectionEnabled parameter indicates the desired operation to perform on the metrics. (MetricService_MetricCollectionEnabled)
    /// * `subject` - The Subject parameter identifies managed element(s) for which metrics will be controlled. (CIM_ManagedElement)

    /// * `return_value` -  (u32)
    pub fn control_metrics(&self, subject: CIM_ManagedElement, definition: CIM_BaseMetricDefinition, metric_collection_enabled: MetricService_MetricCollectionEnabled) -> Result<(), WmiError> {
        let mut args = Vec::new();
        args.push(MethodParameter { name: "Subject".to_string(), value: subject.into() });
        args.push(MethodParameter { name: "Definition".to_string(), value: definition.into() });
        args.push(MethodParameter { name: "MetricCollectionEnabled".to_string(), value: metric_collection_enabled.into() });
        self.invoke_method("ControlMetrics", &args)
...
/// If the Definition parameter is NULL, and the MetricCollectionEnabled parameter has the value 2 "Enabled" or 3 "Disabled", upon successful completion of the method, the MetricCollectionEnabled property of each instance of CIM_MetricDefForME that references an instance of the class identified by the Subject parameter and references an instance of CIM_BaseMetricDefinition that is associated to the CIM_BaseMetricService through the CIM_ServiceAffectsElement association shall have the value of the MetricCollectionEnabled parameter. If the Definition parameter is NULL, and the MetricCollectionEnabled parameter has the value 4 "Reset", upon successful completion of the method, the MetricCollectionEnabled property of each instance of CIM_MetricDefForME that references an instance of the class identified by the Subject parameter and references an instance of CIM_BaseMetricDefinition that is associated to the CIM_BaseMetricService through the CIM_ServiceAffectsElement association shall transition to 3 "Disabled" then to 2 "Enabled". If the Definition parameter is non-NULL, and the MetricCollectionEnabled parameter has the value 2 "Enable" or 3 "Disable", upon successful completion of the method the MetricCollectionEnabled property of each instance of CIM_MetricDefForME that references the instance of CIM_BaseMetricDefinition identified by the Definition parameter and references an instance of the class identified by the Subject parameter shall have the value of the MetricCollectionEnabled parameter. If the Definition parameter is non-NULL, and the MetricCollectionEnabled parameter has the value 4 "Reset", upon successful completion of the method the MetricCollectionEnabled property of each instance of CIM_MetricDefForME that references the instance of CIM_BaseMetricDefinition identified by the Definition parameter and references an instance of the class identified by the Subject parameter shall transition to 3 "Disabled" then to 2 "Enabled". For each instance of the class identified by the Subject parameter, if there is not an instance of CIM_MetricDefForME that associates the CIM_BaseMetricDefinition instance identified by the Definition parameter to the instance, the method shall return 2 "Failed". If the Subject and Definition parameters are both NULL, the method shall return 2 "Failed". If the Definition parameter is a reference to an instance of CIM_BaseMetricDefinition that is not associated to the CIM_MetricService through CIM_ServiceAffectsElement, the method shall return 2 "Failed". If the Subject parameter does not identify a single CIM Class the Method shall return 2 "Failed".
    ...
    /// * `definition` - The Definition parameter identifies a CIM_BaseMetricDefinition for which metrics will be controlled. (CIM_BaseMetricDefinition)
    /// * `metric_collection_enabled` - The MetricCollectionEnabled parameter indicates the desired operation to perform on the metrics. (MetricService_MetricCollectionEnabled)
    /// * `subject` - The Subject parameter identifies the CIM class for which metrics will be controlled. (CIM_ManagedElement)

    /// * `return_value` -  (u32)
    pub fn control_metrics_by_class(&self, subject: CIM_ManagedElement, definition: CIM_BaseMetricDefinition, metric_collection_enabled: MetricService_MetricCollectionEnabled) -> Result<(), WmiError> {
        let mut args = Vec::new();
        args.push(MethodParameter { name: "Subject".to_string(), value: subject.into() });
        args.push(MethodParameter { name: "Definition".to_string(), value: definition.into() });
        args.push(MethodParameter { name: "MetricCollectionEnabled".to_string(), value: metric_collection_enabled.into() });
        self.invoke_method("ControlMetricsByClass", &args)
...
/// If the Definition parameter is NULL, the method shall return 2 "Failed". If the Definition parameter is a reference to an instance of CIM_BaseMetricDefinition with which the CIM_MetricService is not associated through CIM_ServiceAffectsElement, the method shall return 2 "Failed".
    ...
    /// * `count` - The Count parameter identifies the maximum number of instances to to be returned by the method. (u16)
    /// * `definition` - The Definition parameter identifies a CIM_BaseMetricDefinition for which metrics will be returned. (CIM_BaseMetricDefinition)
    /// * `range` - The Range parameter identifies how the instances are selected. The algorithm for ordering value instances is metric definition specific. (MetricService_Range)

    /// * `return_value` -  (u32)
    /// * `values` - Upon successful completion of the method, the Values parameter contains references to instances of CIM_BaseMetricValue, filteredaccording to the values of the input parameters. (CIM_BaseMetricValue[])
    pub fn get_metric_values(&self, definition: CIM_BaseMetricDefinition, range: MetricService_Range, count: u16, values: &mut Vec<CIM_BaseMetricValue>) -> Result<(), WmiError> {
        let mut args = Vec::new();
        args.push(MethodParameter { name: "Definition".to_string(), value: definition.into() });
        args.push(MethodParameter { name: "Range".to_string(), value: range.into() });
        args.push(MethodParameter { name: "Count".to_string(), value: count.into() });

        let result = self.invoke_method("GetMetricValues", &args)?;
...
/// Whenever sampling for additional metrics is started, the settings specified by this method may be used.
    ...
    /// * `preferred_sample_interval` - Preferred sample interval time. In order to get correlatable metrics, it is recommended that the sample interval be chosen in a way that 3600 modulo sample interval time in seconds is equal to 0.  It is the responsibility of the CIM metric service implementation to decide whether the requested sample interval time is honored.  The CIM client can check whether or not the metric providers are honoring the requested sample interval time by retrieving related BaseMetricDefinition instances and checking the contents of the "CIM_BaseMetricDefinition.SampleInterval" property. (String)
    /// * `restart_gathering` - Boolean that when set to TRUE requests that gathering of all metrics associated to the metric service is re-started with this method call. (bool)
    /// * `start_sample_time` - Point in time when sampling for the metrics is to be started.  A value of 99990101000000.000000+000 shall indicate that sampling should start at the next time it is synchronized to the full hour. Sampling is synchronized to the full hour if seconds since midnight modulo sample interval in seconds is equal to 0. (String)

    /// * `return_value` -  (u32)
    pub fn control_sample_times(&self, start_sample_time: &String, preferred_sample_interval: &String, restart_gathering: bool) -> Result<(), WmiError> {
        let mut args = Vec::new();
        args.push(MethodParameter { name: "StartSampleTime".to_string(), value: start_sample_time.into() });
        args.push(MethodParameter { name: "PreferredSampleInterval".to_string(), value: preferred_sample_interval.into() });
        args.push(MethodParameter { name: "RestartGathering".to_string(), value: restart_gathering.into() });
        self.invoke_method("ControlSampleTimes", &args)
