...
/// List of template schemas supported
    #[serde(rename = "SupportedTemplateSchemaVersions")]
    pub supported_template_schema_versions: Vec<String>,
...
impl Configuration {
    ...
    pub fn new() -> Self {
        Self {
            ...
            supported_template_schema_versions: Vec::new(),
            sync_enabled: None,
            sync_method: None,
    ...
    /// Sets the value of SupportedTemplateSchemaVersions
    pub fn set_supported_template_schema_versions(&mut self, value: Vec<String>) {
        self.supported_template_schema_versions = value;
    }

    /// Gets the value of SupportedTemplateSchemaVersions
    pub fn get_supported_template_schema_versions(&self) -> &Vec<String> {
        &self.supported_template_schema_versions
    }
