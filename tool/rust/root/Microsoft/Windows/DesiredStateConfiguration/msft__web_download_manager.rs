...
pub struct MSFT_WebDownloadManager {
    #[serde(flatten)]
    pub base: OMI_ConfigurationDownloadManager,
...
/// 
    #[serde(rename = "ConfigurationNames")]
...
impl MSFT_WebDownloadManager {
    /// Creates a new instance of the struct
    pub fn new() -> Self {
        Self {
            base: OMI_ConfigurationDownloadManager::new(),
    ...
    /// Sets the value of ConfigurationNames
    pub fn set_configuration_names(&mut self, value: Vec<String>) {
        self.configuration_names = value;
    }

    /// Gets the value of ConfigurationNames
