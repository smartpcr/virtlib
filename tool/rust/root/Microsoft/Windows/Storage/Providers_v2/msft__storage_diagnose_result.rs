...
/// 
    ...
    pub perceived_severity: Option<StorageDiagnoseResult_PerceivedSeverity>,
...
impl MSFT_StorageDiagnoseResult {
    ...
    pub fn set_perceived_severity(&mut self, value: StorageDiagnoseResult_PerceivedSeverity) {
        self.perceived_severity = Some(value);
    }

    /// Gets the value of PerceivedSeverity
    pub fn get_perceived_severity(&self) -> Option<&StorageDiagnoseResult_PerceivedSeverity> {
