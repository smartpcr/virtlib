...
/// The state change of the alert.
    ...
    pub change_type: Option<StorageFaultEvent_ChangeType>,
...
impl MSFT_StorageFaultEvent {
    ...
    pub fn set_change_type(&mut self, value: StorageFaultEvent_ChangeType) {
        self.change_type = Some(value);
    }

    /// Gets the value of ChangeType
    pub fn get_change_type(&self) -> Option<&StorageFaultEvent_ChangeType> {
