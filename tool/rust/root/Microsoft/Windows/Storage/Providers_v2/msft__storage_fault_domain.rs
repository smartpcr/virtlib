...
/// 
    ...
    pub health_status: Option<StorageFaultDomain_HealthStatus>,
...
/// 
    ...
    pub operational_status: Vec<StorageFaultDomain_OperationalStatus>,
...
impl MSFT_StorageFaultDomain {
    ...
    pub fn set_health_status(&mut self, value: StorageFaultDomain_HealthStatus) {
        self.health_status = Some(value);
    }

    /// Gets the value of HealthStatus
    pub fn get_health_status(&self) -> Option<&StorageFaultDomain_HealthStatus> {
    ...
    pub fn set_operational_status(&mut self, value: Vec<StorageFaultDomain_OperationalStatus>) {
        self.operational_status = value;
    }

    /// Gets the value of OperationalStatus
    pub fn get_operational_status(&self) -> &Vec<StorageFaultDomain_OperationalStatus> {
