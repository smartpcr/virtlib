...
/// VirtualDiskToVirtualDisk_ProgressStatus enumeration
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, serde::Serialize, serde::Deserialize)]
#[repr(i32)]
pub enum VirtualDiskToVirtualDisk_ProgressStatus {
    /// Unknown
...
impl Default for VirtualDiskToVirtualDisk_ProgressStatus {
    fn default() -> Self {
        Self::Unknown
    }
}
