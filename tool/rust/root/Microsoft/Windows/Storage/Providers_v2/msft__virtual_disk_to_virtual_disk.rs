...
/// 9 - 'Snap-And-Clone': The service creates a snapshot of the source element first, then uses the snapshot as the source of the copy operation to the target element.
    ...
    pub copy_methodology: Option<VirtualDiskToVirtualDisk_CopyMethodology>,
...
/// 3 - 'High': copy engine I/O has higher priority than host I/O.
    ...
    pub copy_priority: Option<VirtualDiskToVirtualDisk_CopyPriority>,
...
/// 14 - 'Mixed': Applies to the CopyState of GroupSynchronized. It indicates the StorageSynchronized associations of the elements in the groups have different CopyState values.
    ...
    pub copy_state: Option<VirtualDiskToVirtualDisk_CopyState>,
...
/// 5 - 'UnSyncUnAssoc': create an unsynchronized copy with a temporary association that is deleted upon completion of the copy operation.
    ...
    pub copy_type: Option<VirtualDiskToVirtualDisk_CopyType>,
...
/// 20 - 'Pending': The flow of data has stopped momentarily due to limited bandwidth or busy system.
    ...
    pub progress_status: Option<VirtualDiskToVirtualDisk_ProgressStatus>,
...
/// 0 - 'Not Specified': The method of maintaining the copy is not specified.
    ...
    pub replica_type: Option<VirtualDiskToVirtualDisk_ReplicaType>,
...
/// Mode describes whether the target elements will be updated synchronously or asynchronously. If NULL, implementation decides the mode.
    ...
    pub sync_mode: Option<VirtualDiskToVirtualDisk_SyncMode>,
...
/// 
    ...
    pub sync_state: Option<VirtualDiskToVirtualDisk_SyncState>,
...
/// 8 - 'Clone': create a point-in-time, full copy the source.
    ...
    pub sync_type: Option<VirtualDiskToVirtualDisk_SyncType>,
...
impl MSFT_VirtualDiskToVirtualDisk {
    ...
    pub fn set_copy_methodology(&mut self, value: VirtualDiskToVirtualDisk_CopyMethodology) {
        self.copy_methodology = Some(value);
    }

    /// Gets the value of CopyMethodology
    pub fn get_copy_methodology(&self) -> Option<&VirtualDiskToVirtualDisk_CopyMethodology> {
        self.copy_methodology.as_ref()
    }

    /// Sets the value of CopyPriority
    pub fn set_copy_priority(&mut self, value: VirtualDiskToVirtualDisk_CopyPriority) {
        self.copy_priority = Some(value);
    }

    /// Gets the value of CopyPriority
    pub fn get_copy_priority(&self) -> Option<&VirtualDiskToVirtualDisk_CopyPriority> {
        self.copy_priority.as_ref()
    }

    /// Sets the value of CopyState
    pub fn set_copy_state(&mut self, value: VirtualDiskToVirtualDisk_CopyState) {
        self.copy_state = Some(value);
    }

    /// Gets the value of CopyState
    pub fn get_copy_state(&self) -> Option<&VirtualDiskToVirtualDisk_CopyState> {
        self.copy_state.as_ref()
    }

    /// Sets the value of CopyType
    pub fn set_copy_type(&mut self, value: VirtualDiskToVirtualDisk_CopyType) {
        self.copy_type = Some(value);
    }

    /// Gets the value of CopyType
    pub fn get_copy_type(&self) -> Option<&VirtualDiskToVirtualDisk_CopyType> {
    ...
    pub fn set_progress_status(&mut self, value: VirtualDiskToVirtualDisk_ProgressStatus) {
        self.progress_status = Some(value);
    }

    /// Gets the value of ProgressStatus
    pub fn get_progress_status(&self) -> Option<&VirtualDiskToVirtualDisk_ProgressStatus> {
        self.progress_status.as_ref()
    }

    /// Sets the value of ReplicaType
    pub fn set_replica_type(&mut self, value: VirtualDiskToVirtualDisk_ReplicaType) {
        self.replica_type = Some(value);
    }

    /// Gets the value of ReplicaType
    pub fn get_replica_type(&self) -> Option<&VirtualDiskToVirtualDisk_ReplicaType> {
    ...
    pub fn set_sync_mode(&mut self, value: VirtualDiskToVirtualDisk_SyncMode) {
        self.sync_mode = Some(value);
    }

    /// Gets the value of SyncMode
    pub fn get_sync_mode(&self) -> Option<&VirtualDiskToVirtualDisk_SyncMode> {
        self.sync_mode.as_ref()
    }

    /// Sets the value of SyncState
    pub fn set_sync_state(&mut self, value: VirtualDiskToVirtualDisk_SyncState) {
        self.sync_state = Some(value);
    }

    /// Gets the value of SyncState
    pub fn get_sync_state(&self) -> Option<&VirtualDiskToVirtualDisk_SyncState> {
    ...
    pub fn set_sync_type(&mut self, value: VirtualDiskToVirtualDisk_SyncType) {
        self.sync_type = Some(value);
    }

    /// Gets the value of SyncType
    pub fn get_sync_type(&self) -> Option<&VirtualDiskToVirtualDisk_SyncType> {
