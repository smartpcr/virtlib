...
/// StorageNodeToPhysicalDisk_OperationalStatus enumeration
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, serde::Serialize, serde::Deserialize)]
#[repr(i32)]
pub enum StorageNodeToPhysicalDisk_OperationalStatus {
    /// Unknown
...
impl Default for StorageNodeToPhysicalDisk_OperationalStatus {
    fn default() -> Self {
        Self::Unknown
    }
}
