...
/// 
    ...
    pub perceived_severity: Option<StorageEvent_PerceivedSeverity>,
...
impl MSFT_StorageEvent {
    ...
    pub fn set_perceived_severity(&mut self, value: StorageEvent_PerceivedSeverity) {
        self.perceived_severity = Some(value);
    }

    /// Gets the value of PerceivedSeverity
    pub fn get_perceived_severity(&self) -> Option<&StorageEvent_PerceivedSeverity> {
