...
/// Indicates the deduplication mode of the volume.
    ...
    pub dedup_mode: Option<DedupProperties_DedupMode>,
...
/// Denotes the compression format for ReFS deduplication.
    ...
    pub re_fsdedup_compression_format: Option<DedupProperties_ReFSDedupCompressionFormat>,
...
/// Indicates the ReFS deduplication mode of the volume.
    ...
    pub re_fsdedup_mode: Option<DedupProperties_ReFSDedupMode>,
...
impl MSFT_DedupProperties {
    ...
    pub fn set_dedup_mode(&mut self, value: DedupProperties_DedupMode) {
        self.dedup_mode = Some(value);
    }

    /// Gets the value of DedupMode
    pub fn get_dedup_mode(&self) -> Option<&DedupProperties_DedupMode> {
    ...
    pub fn set_re_fsdedup_compression_format(&mut self, value: DedupProperties_ReFSDedupCompressionFormat) {
        self.re_fsdedup_compression_format = Some(value);
    }

    /// Gets the value of ReFSDedupCompressionFormat
    pub fn get_re_fsdedup_compression_format(&self) -> Option<&DedupProperties_ReFSDedupCompressionFormat> {
    ...
    pub fn set_re_fsdedup_mode(&mut self, value: DedupProperties_ReFSDedupMode) {
        self.re_fsdedup_mode = Some(value);
    }

    /// Gets the value of ReFSDedupMode
    pub fn get_re_fsdedup_mode(&self) -> Option<&DedupProperties_ReFSDedupMode> {
