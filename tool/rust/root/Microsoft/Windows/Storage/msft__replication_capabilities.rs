...
/// 
    ...
    pub supported_asynchronous_actions: Vec<u16>,

/// 
    #[serde(rename = "SupportedLogVolumeFeatures")]
    pub supported_log_volume_features: Vec<u16>,
...
/// 
    ...
    pub supported_object_types: Vec<u16>,

/// 
    #[serde(rename = "SupportedReplicatedPartitionFeatures")]
    pub supported_replicated_partition_features: Vec<u16>,

/// 
    #[serde(rename = "SupportedReplicationTypes")]
    pub supported_replication_types: Vec<u16>,

/// 
    #[serde(rename = "SupportedSynchronousActions")]
    pub supported_synchronous_actions: Vec<u16>,
