...
/// 
    ...
    pub load_balance_policy: Option<u16>,
...
impl MSFT_StorageNodeToPhysicalDisk {
    ...
    pub fn set_load_balance_policy(&mut self, value: u16) {
        self.load_balance_policy = Some(value);
    }

    /// Gets the value of LoadBalancePolicy
    pub fn get_load_balance_policy(&self) -> Option<&u16> {
    ...
    pub fn set_path_state(&mut self, value: Vec<u16>) {
        self.path_state = value;
    }

    /// Gets the value of PathState
    pub fn get_path_state(&self) -> &Vec<u16> {
        &self.path_state
    }
