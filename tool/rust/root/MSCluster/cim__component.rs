...
/// 
    ...
    pub group_component: Option<CIM_ManagedSystemElement>,

/// 
    #[serde(rename = "PartComponent")]
    pub part_component: Option<CIM_ManagedSystemElement>,
}
...
impl CIM_Component {
    ...
    pub fn set_group_component(&mut self, value: CIM_ManagedSystemElement) {
        self.group_component = Some(value);
    }

    /// Gets the value of GroupComponent
    pub fn get_group_component(&self) -> Option<&CIM_ManagedSystemElement> {
        self.group_component.as_ref()
    }

    /// Sets the value of PartComponent
    pub fn set_part_component(&mut self, value: CIM_ManagedSystemElement) {
        self.part_component = Some(value);
    }

    /// Gets the value of PartComponent
    pub fn get_part_component(&self) -> Option<&CIM_ManagedSystemElement> {
