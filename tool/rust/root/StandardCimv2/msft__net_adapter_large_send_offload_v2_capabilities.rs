...
pub struct MSFT_NetAdapterLargeSendOffloadV2Capabilities {
...
/// 
    ...
    pub ipv6_encapsulation: Option<MSFT_NetAdapterLsoEncapsulationTypes>,
...
/// 
    #[serde(rename = "IPv6TcpOptionsSupported")]
    pub ipv6_tcp_options_supported: Option<bool>,
}

impl MSFT_NetAdapterLargeSendOffloadV2Capabilities {
    ...
    pub fn new() -> Self {
        Self {
            ...
            ipv6_tcp_options_supported: None,
        }
    }
    ...
    pub fn set_ipv6_encapsulation(&mut self, value: MSFT_NetAdapterLsoEncapsulationTypes) {
        self.ipv6_encapsulation = Some(value);
    }

    /// Gets the value of IPv6Encapsulation
    pub fn get_ipv6_encapsulation(&self) -> Option<&MSFT_NetAdapterLsoEncapsulationTypes> {
    ...
    /// Sets the value of IPv6TcpOptionsSupported
    pub fn set_ipv6_tcp_options_supported(&mut self, value: bool) {
        self.ipv6_tcp_options_supported = Some(value);
    }

    /// Gets the value of IPv6TcpOptionsSupported
    pub fn get_ipv6_tcp_options_supported(&self) -> Option<&bool> {
        self.ipv6_tcp_options_supported.as_ref()
    }
}
