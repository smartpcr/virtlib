...
pub struct MSFT_NetIKECryptoSet {
    #[serde(flatten)]
...
/// 
    ...
    pub proposals: Vec<MSFT_NetIKECryptoProposal>,
...
impl MSFT_NetIKECryptoSet {
    ...
    pub fn set_proposals(&mut self, value: Vec<MSFT_NetIKECryptoProposal>) {
        self.proposals = value;
    }

    /// Gets the value of Proposals
    pub fn get_proposals(&self) -> &Vec<MSFT_NetIKECryptoProposal> {
        &self.proposals
    }
