...
/// ResourceAllocationSettingData_ResourceType enumeration
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, serde::Serialize, serde::Deserialize)]
#[repr(i32)]
pub enum ResourceAllocationSettingData_ResourceType {
    /// Other
    #[serde(rename = "Other")]
    Other = 1,
    /// Computer_System
...
impl Default for ResourceAllocationSettingData_ResourceType {
    fn default() -> Self {
        Self::Other
    }
}
