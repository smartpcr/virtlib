...
/// ReplicationService_InitialReplicationType enumeration
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, serde::Serialize, serde::Deserialize)]
#[repr(i32)]
pub enum ReplicationService_InitialReplicationType {
    /// Network_Transfer
...
impl Default for ReplicationService_InitialReplicationType {
    fn default() -> Self {
