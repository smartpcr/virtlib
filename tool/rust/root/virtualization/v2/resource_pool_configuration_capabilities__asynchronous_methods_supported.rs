...
/// ResourcePoolConfigurationCapabilities_AsynchronousMethodsSupported enumeration
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, serde::Serialize, serde::Deserialize)]
#[repr(i32)]
pub enum ResourcePoolConfigurationCapabilities_AsynchronousMethodsSupported {
    ...
    #[serde(rename = "ChangeParentResourcePool_is_supported")]
    ChangeParentResourcePoolIsSupported = 7,
    /// DMTF_Reserved
...
impl Default for ResourcePoolConfigurationCapabilities_AsynchronousMethodsSupported {
    fn default() -> Self {
