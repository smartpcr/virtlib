...
impl Msvm_VirtualSystemManagementService {
    ...
    /// Gets the related Msvm_VirtualSystemManagementCapabilities object(s)
    pub fn get_related__virtual_system_management_capabilities(&self) -> Result<Msvm_VirtualSystemManagementCapabilities, WmiError> {
        self.get_related("Msvm_VirtualSystemManagementCapabilities")
    }
