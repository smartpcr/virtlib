...
/// VirtualSystemManagementCapabilities_SynchronousMethodsSupported enumeration
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, serde::Serialize, serde::Deserialize)]
#[repr(i32)]
pub enum VirtualSystemManagementCapabilities_SynchronousMethodsSupported {
...
impl Default for VirtualSystemManagementCapabilities_SynchronousMethodsSupported {
    fn default() -> Self {
