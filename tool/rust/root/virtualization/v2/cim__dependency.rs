...
impl CIM_Dependency {
    ...
    pub fn set_antecedent(&mut self, value: CIM_ManagedElement) {
        self.antecedent = Some(value);
    }

    /// Gets the value of Antecedent
    pub fn get_antecedent(&self) -> Option<&CIM_ManagedElement> {
        self.antecedent.as_ref()
    }

    /// Sets the value of Dependent
    pub fn set_dependent(&mut self, value: CIM_ManagedElement) {
        self.dependent = Some(value);
    }

    /// Gets the value of Dependent
    pub fn get_dependent(&self) -> Option<&CIM_ManagedElement> {
