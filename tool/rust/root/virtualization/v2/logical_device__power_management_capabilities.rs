...
/// LogicalDevice_PowerManagementCapabilities enumeration
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, serde::Serialize, serde::Deserialize)]
#[repr(i32)]
pub enum LogicalDevice_PowerManagementCapabilities {
    /// Unknown
...
impl Default for LogicalDevice_PowerManagementCapabilities {
    fn default() -> Self {
        Self::Unknown
    }
}
